...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_QpriSpUJCdRXh1c7ghtJFB
        subject_person_id: p_hDt1dBQpLhxLJc7ytN2m1U
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 盧氏，史料所见人物。本项目依据《中国历代人物传记资料库：盧氏(王鈞妻)（CBDB 165255）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 1
      sources:
        - id: cs_dBdovI85WzCN410YZIA35A
          claim_id: c_QpriSpUJCdRXh1c7ghtJFB
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_BTGKqgAPQxGxMVQzCROiEr
          claim_id: c_VWMWdIujvkLKkSFmIAuAZu
          source_id: s_4z2KtNb98LuJtqvAK82dYq
          stance: supports
          locator: CBDB:165255
          quotation: null
          interpretation_note: CBDB 明确记录的王鈞配偶
          source: *a1
      object_person: null
    alternatives: []
relationships:
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 盧氏，史料所见人物。本项目依据《中国历代人物传记资料库：盧氏(王鈞妻)（CBDB 165255）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
...
| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| spouses | p_7QnGBiPzUFUWD8rSwCwAQh | 王鈞 | accepted |
