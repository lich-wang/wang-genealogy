  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_sdY9okFDAQpQVUGZPYyu62
          claim_id: c_A7TjC2XDGesbP8JqkKkfbr
          source_id: s_xEB64aE4z7JbT2bBw4HPfx
          stance: supports
          locator: CBDB:573438
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（573438）
          source: &a1
            id: s_xEB64aE4z7JbT2bBw4HPfx
            source_type: api_record
            title: 中国历代人物传记资料库：王元友（CBDB 573438）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=573438&o=json
            external_identifier: CBDB:573438
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王元友，史料所见人物。本项目依据《中国历代人物传记资料库：王元友（CBDB 573438）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_Dk7ylwQZLe4JhG8gEA3e7F
          claim_id: c_nYUAsv8cZrtTZpU7xSVVtG
          source_id: s_xEB64aE4z7JbT2bBw4HPfx
          stance: supports
          locator: CBDB:573438
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| name.primary | 王元友 | accepted |
| bio.summary | 王元友，史料所见人物。本项目依据《中国历代人物传记资料库：王元友（CBDB 573438）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
