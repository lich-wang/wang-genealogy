  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王元姬（217年—268年），史料所见人物。本项目依据《中国历代人物传记资料库：王元姬（CBDB 135477）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_Sr2Eapoq61k_PHvst4pn3i
          claim_id: c_N7e852JLUsiiV9DpPkZpPP
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_wJE4GHMFnADDTbL5DoRTZT
          claim_id: c_MFd9cZA2xxCxpCzP6aBSHb
          source_id: s_wcR5TAetxYb7Peh1rn9RiC
          stance: supports
          locator: CBDB:135477
          quotation: null
          interpretation_note: CBDB 2026-08-29 Luna 审核通过人物批量导入（301-400）｜历史性依据：CBDB 卒年 = 268
          source:
            id: s_wcR5TAetxYb7Peh1rn9RiC
            source_type: api_record
            title: 中国历代人物传记资料库：王元姬（CBDB 135477）
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_cZmVr7UEjs4MRzbh5PfRP5
          claim_id: c_35hYX31XaqpcLQzwcLwvcb
          source_id: s_wcR5TAetxYb7Peh1rn9RiC
          stance: supports
          locator: CBDB:135477
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_YHtbHAxQmKuHogkzLwcj5T
          claim_id: c_HVrShM8fiHcLqVc2X38V2Y
          source_id: s_wcR5TAetxYb7Peh1rn9RiC
          stance: supports
          locator: CBDB:135477
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王元姬（217年—268年），史料所见人物。本项目依据《中国历代人物传记资料库：王元姬（CBDB 135477）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| birth.date | 217年 | accepted |
| death.date | 268年 | accepted |
| name.primary | 王元姬 | accepted |
