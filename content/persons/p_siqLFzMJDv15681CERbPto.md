...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_pnZX51ySG8DQXAjc1C9KF7
        subject_person_id: p_siqLFzMJDv15681CERbPto
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王十娘，史料所见人物。本项目依据《中国历代人物传记资料库：王十娘（CBDB 150532）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_C-1LPkXXhcfLdjMXQlmR4T
          claim_id: c_pnZX51ySG8DQXAjc1C9KF7
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_1RAeKUsVnrrmYz226n7W4D
          claim_id: c_SobF4jUN9cx8GRxJLH9Umm
          source_id: s_KZBhMbs33pVB7mUscRhas7
          stance: supports
          locator: CBDB:150532
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王十娘，史料所见人物。本项目依据《中国历代人物传记资料库：王十娘（CBDB 150532）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王十娘 | accepted |
