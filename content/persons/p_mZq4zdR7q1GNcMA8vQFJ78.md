  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王祖（655年—733年），史料所见人物。本项目依据《中国历代人物传记资料库：王祖（CBDB 143709）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_uX5SHF8C8DUoCwz52dJRM_
          claim_id: c_EmCHsoJ1RC7j4opUXgHHxU
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_Cr6sGBWtjUos5ZKhi3xG2G
          claim_id: c_JSaFSFhToh2S4vnugWx2Se
          source_id: s_QoKVw3cyuBecJzY4aLqCh3
          stance: supports
          locator: CBDB:143709
          quotation: null
          interpretation_note: CBDB 2026-08-29 Luna 审核通过人物批量导入（401-500）｜历史性依据：CBDB 卒年 = 733
          source:
            id: s_QoKVw3cyuBecJzY4aLqCh3
            source_type: api_record
            title: 中国历代人物传记资料库：王祖（CBDB 143709）
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_t2LqgQkvSuUAz6vHQgSiBY
          claim_id: c_wLbEbieiepFKBbxXLevH2j
          source_id: s_QoKVw3cyuBecJzY4aLqCh3
          stance: supports
          locator: CBDB:143709
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_pRD3bao6AnArnb8nwc1ESi
          claim_id: c_AL44bRCFxgPj1JgEFHiMML
          source_id: s_QoKVw3cyuBecJzY4aLqCh3
          stance: supports
          locator: CBDB:143709
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王祖（655年—733年），史料所见人物。本项目依据《中国历代人物传记资料库：王祖（CBDB 143709）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| birth.date | 655年 | accepted |
| death.date | 733年 | accepted |
| name.primary | 王祖 | accepted |
