  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王支某（747年—803年），史料所见人物。本项目依据《中国历代人物传记资料库：王支某（CBDB 141376）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_4YPnLOH56nLTZY4wqrlDBx
          claim_id: c_54mpKyp32X6EqN5PjA6JyS
          source_id: s_QxY9AFJmEBUYveNfrg5Vp2
          stance: supports
          locator: CBDB:141376
          quotation: null
          interpretation_note: 自动补全人物基本介绍；身份由稳定外部标识锁定，信息来源层级为 source。
          source: &a1
            id: s_QxY9AFJmEBUYveNfrg5Vp2
            source_type: api_record
            title: 中国历代人物传记资料库：王支某（CBDB 141376）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=141376&o=json
            external_identifier: CBDB:141376
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_XCA9tPUo5hX9vTDiYHwkXU
          claim_id: c_JGsDX9JerKLCzotkSKPKEr
          source_id: s_QxY9AFJmEBUYveNfrg5Vp2
          stance: supports
          locator: CBDB:141376
          quotation: null
          interpretation_note: CBDB 2026-08-29 Luna 审核通过人物批量导入（401-500）｜历史性依据：CBDB 卒年 = 803
          source:
            id: s_QxY9AFJmEBUYveNfrg5Vp2
            source_type: api_record
            title: 中国历代人物传记资料库：王支某（CBDB 141376）
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_BrpCk43DkW9C9aGVTHcRny
          claim_id: c_x1qk8ZL7BissBq24Kra47u
          source_id: s_QxY9AFJmEBUYveNfrg5Vp2
          stance: supports
          locator: CBDB:141376
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_VFQxdVcK176E7VVsuE38ZF
          claim_id: c_JYVP9qZN8982KybKh2WPAr
          source_id: s_QxY9AFJmEBUYveNfrg5Vp2
          stance: supports
          locator: CBDB:141376
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王支某（747年—803年），史料所见人物。本项目依据《中国历代人物传记资料库：王支某（CBDB 141376）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| birth.date | 747年 | accepted |
| death.date | 803年 | accepted |
| name.primary | 王支某 | accepted |
...
| children | p_Ga4exmxcHLAX2Pat1WL3rz | 王貞鎰 | accepted |
| ancestors | p_EG5yKUEaWTYurjNt333buJ | 王同皎 | accepted |
| ancestors | p_Lr8L9s9EF6He1HszkYXFMW | 王繇 | accepted |
