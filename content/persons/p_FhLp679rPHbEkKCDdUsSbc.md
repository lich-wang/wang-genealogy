...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_RJGl4VBU7cXBTxwDxt8jsm
        subject_person_id: p_FhLp679rPHbEkKCDdUsSbc
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 劉氏，史料所见人物。本项目依据《中国历代人物传记资料库：劉氏(王崇禮妻)（CBDB 152391）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 1
      sources:
        - id: cs_hIwPji6qdVoHWPiRN9-iXQ
          claim_id: c_RJGl4VBU7cXBTxwDxt8jsm
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_QkdasojZGRgY3VG59OYL_Z
          claim_id: c_vXw7tntyA5RwH-pGuTfew3
          source_id: s_bu3G_MOQRj7sRrpehnFENf
          stance: supports
          locator: CBDB:152391
          quotation: null
          interpretation_note: CBDB 明确记录的王崇禮配偶
          source: *a1
      object_person: null
    alternatives: []
relationships:
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 劉氏，史料所见人物。本项目依据《中国历代人物传记资料库：劉氏(王崇禮妻)（CBDB 152391）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
...
| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| spouses | p_H5XJ9wsBqaUG7iLGVt5LMg | 王崇禮 | accepted |
