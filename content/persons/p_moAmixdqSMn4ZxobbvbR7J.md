  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王堯善，宋人物。籍贯洛陽。（中国历代人物传记资料库 CBDB 26316）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 7
...
relationships:
  ...
  children:
    ...
    - claim:
        id: c_HYaqiZrHlI_TGjkrtVHZpU
        subject_person_id: p_moAmixdqSMn4ZxobbvbR7J
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_zBgnz4rdnu4caCZARiNHFa
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_OJbHRgSLNToytnbQzD9kPP
          claim_id: c_HYaqiZrHlI_TGjkrtVHZpU
          source_id: s_aRDUvzEh8l-B4QWxjmOB-L
          stance: supports
          locator: CBDB 亲属：父（KinPerson 26316）
          quotation: null
          interpretation_note: CBDB 直接记录的父／母关系。
          source:
            id: s_aRDUvzEh8l-B4QWxjmOB-L
            source_type: api_record
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王堯善，宋人物。籍贯洛陽。（中国历代人物传记资料库 CBDB 26316） | accepted |
...
| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| children | p_qG9JXBeucMH2LCMW4xXGLj | 王溥 | accepted |
| children | p_zBgnz4rdnu4caCZARiNHFa | 王涇 | accepted |
