...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_Mzvm81b5m89WMHFCAmsTHT
        subject_person_id: p_2mtGKG4ErXixRJHPUBFMdq
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_hfZE9TAGdHrAChLsGCBrYY
          claim_id: c_Mzvm81b5m89WMHFCAmsTHT
          source_id: s_BRFVJ8HpbD6Cgc5RxFmz6J
          stance: supports
          locator: CBDB:527010
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（527010）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王如久，史料所见人物。本项目依据《中国历代人物传记资料库：王如久（CBDB 527010）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_m-9eFaQSW9uUbevV31vWeo
          claim_id: c_6kYpPJiM31ozQK4hk5rMvu
          source_id: s_BRFVJ8HpbD6Cgc5RxFmz6J
          stance: supports
          locator: CBDB:527010
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| name.primary | 王如久 | accepted |
| bio.summary | 王如久，史料所见人物。本项目依据《中国历代人物传记资料库：王如久（CBDB 527010）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
