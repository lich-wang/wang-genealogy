  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_dLmDVWX36RhJaEcrqZqSRW
          claim_id: c_QuvC5kvEj26yUCS8KxLbCu
          source_id: s_XEyVmsJi464FkLSXdRq3Hb
          stance: supports
          locator: null
          quotation: null
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_EEhRWAXQzDGttZwWj5eUsN
          claim_id: c_DShRwF2MJiaBLJcgqUgKPi
          source_id: s_XEyVmsJi464FkLSXdRq3Hb
          stance: supports
          locator: null
          quotation: null
...
relationships:
  ...
  ancestors:
    - claim:
        ...
        current_revision: 2
      sources:
        - id: cs_BMAeMaNSKwXR39Wrz7SNpQ
          claim_id: c_oNsSjYYrxrBNWMn81HMfyK
          source_id: s_bV4n2HGMjjM8BnJ5QVBFob
          stance: supports
          locator: 条文：条文识读（祖）（2世）
          quotation: 祖父王份为梁朝左光禄大夫
          interpretation_note: null
          source:
            id: s_bV4n2HGMjjM8BnJ5QVBFob
            source_type: website
            title: 中文维基百科：王通 (南朝)
            creator: 维基百科贡献者
            publisher: Wikimedia Foundation
            ...
            external_identifier: null
            license_code: CC-BY-SA-4.0
            accessed_at: 2026-08-25T09:56:54.232Z
            metadata_json: null
      object_person:
  ...
  descendants:
    - claim:
        ...
        current_revision: 2
      sources:
        - id: cs_MzTZR7bosDfCAm5mW4CL17
          claim_id: c_ZJjbd3KuKfXGF1JBgMpQ78
    ...
    - claim:
        ...
        current_revision: 2
      sources:
        - id: cs_cLDvL1pWj7rAbUSSC2fSwB
          claim_id: c_uKmuEd8eixW4uqKJau4wM4
    ...
    - claim:
        ...
        current_revision: 2
      sources:
        - id: cs_PHG2CLEJc5vcjRrd9e5YaL
          claim_id: c_LnJyLV4KjKW4XNSTkiQqar
          source_id: s_EEBRBGgmG7xzo6uPRdakg5
          stance: supports
          locator: 条文：条文识读（ancestor）（2世）
          quotation: 王通之孙，王福畤之子。
          interpretation_note: null
          source:
...
| children | p_fCpXRw3ympYVRWdSX3T5cq | 王福畤 | accepted |
| children | p_39vDkBBkr1izfyQ9ri13ms | 王福郊 | accepted |
| ancestors | p_J1Ags3R9DpGyBdsdxESQDz | 王份 | accepted |
| descendants | p_3rXpgVa7b3w2KvtV9muyJp | 王勃 | accepted |
| descendants | p_3CDBAkcgG1mnkdjqn6afQr | 王勮 | accepted |
| descendants | p_1HFrXhR5k8Wh7RX7Cyq9Qe | 王助 | accepted |
