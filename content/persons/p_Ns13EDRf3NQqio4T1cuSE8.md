  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王景秀（699年—776年），史料所见人物。本项目依据《中国历代人物传记资料库：王景秀（CBDB 141201）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_y6tB_mYGGumgRoWElo3PQx
          claim_id: c_BR2b4XkKS9J5BXCcEVqRA9
          source_id: s_QrGofA4hajBiQgeCHgpDni
          stance: supports
          locator: CBDB:141201
          quotation: null
          interpretation_note: 自动补全人物基本介绍；身份由稳定外部标识锁定，信息来源层级为 source。
          source: &a1
            id: s_QrGofA4hajBiQgeCHgpDni
            source_type: api_record
            title: 中国历代人物传记资料库：王景秀（CBDB 141201）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=141201&o=json
            external_identifier: CBDB:141201
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_j4mHdRTgLNMFS69kySoF87
          claim_id: c_M6gqHmJBwMQi26MMHzT9aq
          source_id: s_QrGofA4hajBiQgeCHgpDni
          stance: supports
          locator: CBDB:141201
          quotation: null
          interpretation_note: CBDB 2026-08-29 Luna 审核通过人物批量导入（401-500）｜历史性依据：CBDB 卒年 = 776
          source:
            id: s_QrGofA4hajBiQgeCHgpDni
            source_type: api_record
            title: 中国历代人物传记资料库：王景秀（CBDB 141201）
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_zQc1tKQHjSjkXBywJKqvhM
          claim_id: c_Q4tX8FA7sT9VN3Wb11K5Ys
          source_id: s_QrGofA4hajBiQgeCHgpDni
          stance: supports
          locator: CBDB:141201
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_oEHR55WQSn4ZB423MK4AW2
          claim_id: c_GtLZzR5KNn4L9JS4YqPpkM
          source_id: s_QrGofA4hajBiQgeCHgpDni
          stance: supports
          locator: CBDB:141201
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王景秀（699年—776年），史料所见人物。本项目依据《中国历代人物传记资料库：王景秀（CBDB 141201）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| birth.date | 699年 | accepted |
| death.date | 776年 | accepted |
| name.primary | 王景秀 | accepted |
