...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_-Jrb3lqOw1urttMRrm82cW
        subject_person_id: p_gU4WTuxS5a8iwDm9VLJE1n
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王广廉（卒于1072年），史料所见人物。本项目依据《王广廉》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 4
      sources:
        - id: cs_BMoeqIucyxeo0_SC5FESPU
          claim_id: c_-Jrb3lqOw1urttMRrm82cW
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_WkVkHbWMiER5YX89EjAVPp
          claim_id: c_GcLaWYJxBzfw9MUibWLYiQ
          source_id: s_JS4P2uMGLxNkCsMFe6eJep
          stance: supports
          locator: null
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_umRh2oj9t4vAXcg8uwoKVU
          claim_id: c_dFCFwHUSn675BbeMnCa9So
          source_id: s_JS4P2uMGLxNkCsMFe6eJep
          stance: supports
          locator: Q15895306
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王广廉（卒于1072年），史料所见人物。本项目依据《王广廉》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| death.date | 1072年 | accepted |
| name.primary | 王广廉 | accepted |

## 关联关系

| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| parents | p_KRbkHpeLxDkuVdC7HwPWBH | 王D | accepted |
