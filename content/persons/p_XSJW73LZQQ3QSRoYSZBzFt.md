...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_99AhvihENHjyG7m9ULf5ZB
        subject_person_id: p_XSJW73LZQQ3QSRoYSZBzFt
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_4Fk2TRZQ4BnEQYeVhK5adj
          claim_id: c_99AhvihENHjyG7m9ULf5ZB
          source_id: s_yqbW9ZjhR1qvMP3vpJxysm
          stance: supports
          locator: CBDB:528037
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（528037）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王夢舃，史料所见人物。本项目依据《中国历代人物传记资料库：王夢舃（CBDB 528037）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_Jxi6pmUbxNN37EGbFc2ugc
          claim_id: c_MbeSkxYK2nkAfWWJRcKBMA
          source_id: s_yqbW9ZjhR1qvMP3vpJxysm
          stance: supports
          locator: CBDB:528037
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| name.primary | 王夢舃 | accepted |
| bio.summary | 王夢舃，史料所见人物。本项目依据《中国历代人物传记资料库：王夢舃（CBDB 528037）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
