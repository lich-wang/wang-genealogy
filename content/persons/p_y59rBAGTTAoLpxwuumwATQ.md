...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_luq76ljU4juSvLz5WL8Jsa
        subject_person_id: p_y59rBAGTTAoLpxwuumwATQ
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 閻氏，史料所见人物。本项目依据《中国历代人物传记资料库：閻氏(王敬妻)（CBDB 162877）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 1
      sources:
        - id: cs__7bwzWXUwtYCAMQLdnJNFe
          claim_id: c_luq76ljU4juSvLz5WL8Jsa
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_KcE_oDLzIaiV8qd6eFFBoe
          claim_id: c_bhp-r__qN-h-ztVbsnZuub
          source_id: s_KGKKD0fTGv8SZJ2VSp8Te1
          stance: supports
          locator: CBDB:162877
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 閻氏，史料所见人物。本项目依据《中国历代人物传记资料库：閻氏(王敬妻)（CBDB 162877）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
