...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_mshCtpR4SpBGW9M8DaGip1
        subject_person_id: p_wenbgPvgWA9P5GDbaaKLFv
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王宝（卒于857年），唐人物。CBDB 记录其籍贯记录为咸陽。中国历代人物传记资料库（CBDB）以人物编号 175494 收录其独立传记记录；未列明的生平细节仍待可靠史料补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 3
      sources:
        - id: cs_xWjEtz18y4ixpt58PE7psP
          claim_id: c_mshCtpR4SpBGW9M8DaGip1
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_iQriPfPXwA5Mjf5jNrHjxe
          claim_id: c_9M8KHUE67mQNYD6jz5VMwU
          source_id: s_7m6gaWcHcANQa6io1JZJMn
          stance: supports
          locator: null
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_m4w5P4xjA7yYLQM7VF88Fs
          claim_id: c_WrsgvnqxRGMgvfoNpFgADD
          source_id: s_7m6gaWcHcANQa6io1JZJMn
          stance: supports
          locator: Q45662981
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王宝（卒于857年），唐人物。CBDB 记录其籍贯记录为咸陽。中国历代人物传记资料库（CBDB）以人物编号 175494 收录其独立传记记录；未列明的生平细节仍待可靠史料补充。 | accepted |
| death.date | 857年 | accepted |
| name.primary | 王宝 | accepted |
