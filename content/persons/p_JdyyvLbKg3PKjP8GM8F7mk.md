  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王君德（592年—670年），唐人物。籍贯晉陽，曾任縣令。（中国历代人物传记资料库 CBDB 139598）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_7u5b8sfWBvlvu4qB0Mu_ak
...
relationships:
  parents:
    - claim:
        id: c_ge9esnLMeqJ8EAbrvs3DaC
        subject_person_id: p_itBZawe8AbuUvqdUvcXAzR
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_JdyyvLbKg3PKjP8GM8F7mk
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_GxSCk4gdBXiJboIz4cRGBp
          claim_id: c_ge9esnLMeqJ8EAbrvs3DaC
          source_id: s_Mt1RzKaAkxzwxFWB5KX8PC
          stance: supports
          locator: 唐代墓誌匯編:二卷，Xianheng 18：子
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_Mt1RzKaAkxzwxFWB5KX8PC
            source_type: api_record
            title: 中国历代人物传记资料库：王約（CBDB 148471）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=148471&o=json
            external_identifier: CBDB:148471
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-09T00:03:15.761Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_itBZawe8AbuUvqdUvcXAzR
        status: active
        display_name: 王約
        merged_into_person_id: null
  children:
    - claim:
        id: c_HxTVh8CLFAuLQPYcBM7CtO
        subject_person_id: p_JdyyvLbKg3PKjP8GM8F7mk
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_dKQzMtzUR4AkAwrFXKENdW
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_j2JhnyKOk2QUZcqNYCCx56
          claim_id: c_HxTVh8CLFAuLQPYcBM7CtO
          source_id: s_acscHRwJDMudJf62iT5XZk
          stance: supports
          locator: 唐代墓誌匯編:二卷，Xianheng 18：父
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_acscHRwJDMudJf62iT5XZk
            source_type: api_record
            title: 中国历代人物传记资料库：王明朗（CBDB 148472）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=148472&o=json
            external_identifier: CBDB:148472
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-06T01:16:53.368Z
            metadata_json:
              source_release: CBDB 2026-08-29
      object_person:
        id: p_dKQzMtzUR4AkAwrFXKENdW
        status: active
        display_name: 王明朗
        merged_into_person_id: null
    - claim:
...
| bio.summary | 王君德（592年—670年），唐人物。籍贯晉陽，曾任縣令。（中国历代人物传记资料库 CBDB 139598） | accepted |

## 关联关系

| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| parents | p_itBZawe8AbuUvqdUvcXAzR | 王約 | accepted |
| children | p_dKQzMtzUR4AkAwrFXKENdW | 王明朗 | accepted |
| children | p_ZJu1PJprCkBLsTXF61RrPj | 王明感 | accepted |
...
- [中国历代人物传记资料库：王明朗（CBDB 148472）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=148472&o=json)
- [中国历代人物传记资料库：王約（CBDB 148471）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=148471&o=json)
