...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_aOKxqYDLjR6qlyFV6r3kkS
        subject_person_id: p_iVC2o9GwxoxLP7sDmdacPA
        claim_kind: property
        predicate: bio.summary
        ...
        current_revision: 2
      sources:
        - id: cs_GO95Q_ObWePhy5uErsj_BI
          claim_id: c_aOKxqYDLjR6qlyFV6r3kkS
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_G1ke1iRv7nfGs7zcRLgBx5
          claim_id: c_FrLFCRWB4RJk8nSDjGSvp7
          source_id: s_MGBoig692jprej3f8uiDi2
          stance: supports
          locator: 条文：世系圖
          quotation: 琅邪王氏世系圖 世系圖：王裁 → 王敞
          interpretation_note: 库内原有的「王敞」记录身份来自中文维基百科《王奉光》条，即西汉邛成侯王奉光之子、袭封邛成侯的王敞。琅邪王氏的王敞（王裁之子、王導之弟）是另一人，相隔三百余年：《新唐書·宰相世系表》「栽字士初…三子：導、穎、敞」，《琅邪王氏世系圖》亦另有其框。
          source: *a1
      object_person: null
    alternatives: []
relationships:
