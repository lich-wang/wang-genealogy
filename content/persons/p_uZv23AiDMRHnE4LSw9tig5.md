...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_V81hWcCqAPqoEB15oHpQJ1
        subject_person_id: p_uZv23AiDMRHnE4LSw9tig5
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王敏吉，明人物。正統四年進士，籍贯無錫。（中国历代人物传记资料库 CBDB 237271）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 7
      sources:
        - id: cs_oXjB6VktvcmCSq66-3NrUQ
          claim_id: c_V81hWcCqAPqoEB15oHpQJ1
          source_id: s_AmG3eswKyWUyKpV9r2AAxt
          stance: supports
          locator: CBDB:237271
          quotation: null
          interpretation_note: 自动补全人物基本介绍；身份由稳定外部标识锁定，信息来源层级为 cbdb。
          source: &a1
            id: s_AmG3eswKyWUyKpV9r2AAxt
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_EBiS3pqLa7VV8MoG5uh2Cv
          claim_id: c_Z76w8PPyVdSUvDJa22FXPv
          source_id: s_AmG3eswKyWUyKpV9r2AAxt
          stance: supports
          locator: CBDB:237271
          quotation: null
...
relationships:
  parents:
    - claim:
        ...
        current_revision: 1
      sources:
        - id: cs_NU8SitISqQESN93WgCzPnP
          claim_id: c_Aw9OeUl62p46R9l0CaOS9l
          source_id: s_VoGQX7_wStH027YMg1hUfl
          stance: supports
          locator: CBDB：兄弟 王訥（207872）之父／母 王景深
          quotation: null
          interpretation_note: 由兄弟关系推断：王敏吉 与 王訥 为同胞（CBDB 记「弟」），王訥 之父／母即 王敏吉 之父／母。
          source:
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王敏吉，明人物。正統四年進士，籍贯無錫。（中国历代人物传记资料库 CBDB 237271） | accepted |
| name.primary | 王敏吉 | accepted |
