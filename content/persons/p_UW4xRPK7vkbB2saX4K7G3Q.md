  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王廞，史料所见人物。本项目依据《王廞》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 3
      sources:
        - id: cs_1_LBIFNJOqnfuR4m7p5nV6
          claim_id: c_-6c9F4BGpnHzkAO8HWiqea
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_E1B9oT6jv7wgeJA8piJqPT
          claim_id: c_G3isadYAjPjp2CNAq94xDn
          source_id: s_1NXXuebmmX2qGQYbP9ULDx
          stance: supports
          locator: Q22814780
          quotation: null
...
relationships:
  ...
  children:
    - claim:
        id: c_DLUcAz6D8KXq3Ehw5avfKs
        subject_person_id: p_UW4xRPK7vkbB2saX4K7G3Q
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_X9FxmtvnLfHPoAs6JVdQaL
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 3
      sources:
        - id: cs_cymZFXB41gw3P3hgmJSKRx
          claim_id: c_DLUcAz6D8KXq3Ehw5avfKs
          source_id: s_1NXXuebmmX2qGQYbP9ULDx
          stance: supports
          locator: P40（子女）
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王廞，史料所见人物。本项目依据《王廞》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王廞 | accepted |
...
| children | p_X9FxmtvnLfHPoAs6JVdQaL | 王华 (刘宋) | accepted |
| children | p_mW1NVSgRdkVtMz14818ByV | 王泰 | accepted |
