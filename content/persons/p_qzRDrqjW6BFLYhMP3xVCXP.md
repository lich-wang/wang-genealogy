  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: "王尙志，清人物。籍贯海鹽，身份为孝子/孝女，入仕學校: 生員(庠生)。（中国历代人物传记资料库 CBDB 694288）"
          language: zh-Hant
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_suEcKfd0KCVMXxp1Cf2F-c
...
relationships:
  ...
  other:
    - claim:
        id: c_PCY3pn1yV3oVIzfUEaZ5hg
        subject_person_id: p_exVPUvM5pJEY8oaS9fKMdm
        claim_kind: relationship
        predicate: kinship.sibling_of
        object_person_id: p_qzRDrqjW6BFLYhMP3xVCXP
        generation_count: null
        parent_role: null
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_PpWeVw0MDTM-fBU4JcK-OT
          claim_id: c_PCY3pn1yV3oVIzfUEaZ5hg
          source_id: s_vR6lM5739rO2xkgHKseic4
          stance: supports
          locator: CBDB 亲属：弟（KinPerson 694288 王尙志）
          quotation: null
          interpretation_note: CBDB 记录的同辈兄弟姊妹关系，按字典序规范化存储。
          source:
            id: s_vR6lM5739rO2xkgHKseic4
            source_type: api_record
...
| bio.summary | 王尙志，清人物。籍贯海鹽，身份为孝子/孝女，入仕學校: 生員(庠生)。（中国历代人物传记资料库 CBDB 694288） | accepted |
...
| other | p_exVPUvM5pJEY8oaS9fKMdm | 王德明 | accepted |
