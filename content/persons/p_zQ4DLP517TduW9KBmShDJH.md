...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_mZLwVXtidu1BDRxjGQ1nLM
        subject_person_id: p_zQ4DLP517TduW9KBmShDJH
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王有壬，明人物。CBDB 记录其籍贯记录为吳縣，入仕记录为恩蔭、蔭補(籠統)。中国历代人物传记资料库（CBDB）以人物编号 34586 收录其独立传记记录；未列明的生平细节仍待可靠史料补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 3
      sources:
        - id: cs_AbJx4oL5MxCLGvyos3Ha81
          claim_id: c_mZLwVXtidu1BDRxjGQ1nLM
          ...
          source: &a2
            ...
            metadata_json: null
        - id: cs_Vt3LZWHbcDYtpeK3p_hEg2
          claim_id: c_mZLwVXtidu1BDRxjGQ1nLM
          source_id: s_VNiwf81AkfYMPfnykXDvBB
          stance: supports
          locator: CBDB:34586
          quotation: null
          interpretation_note: 自动补全人物基本介绍；身份由稳定外部标识锁定，信息来源层级为 cbdb。
          source: &a1
            id: s_VNiwf81AkfYMPfnykXDvBB
            source_type: api_record
            title: CBDB 中国历代人物传记资料库：王有壬（34586）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=34586&o=json
            external_identifier: CBDB:34586
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-05T02:06:33.991Z
            metadata_json: null
      object_person: null
    alternatives: []
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_2ygTtGjSPwkR9jv2URJDrn
          claim_id: c_jhnEXRaBkES8Phq9KwjWPo
          source_id: s_81NCrSguBPreQrC4V4ZqQy
          stance: supports
          locator: Q45426505
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王有壬，明人物。CBDB 记录其籍贯记录为吳縣，入仕记录为恩蔭、蔭補(籠統)。中国历代人物传记资料库（CBDB）以人物编号 34586 收录其独立传记记录；未列明的生平细节仍待可靠史料补充。 | accepted |
...
| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| parents | p_Mc1TgdkLLeMac37TuMJkgg | 王延 | accepted |
...
- [CBDB 中国历代人物传记资料库：王有壬（34586）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=34586&o=json)
