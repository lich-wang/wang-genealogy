  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王念孙，史料所见人物。本项目依据《王念孙》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 4
      sources:
        - id: cs_23IUifJPAbspnvL9_3pWde
          claim_id: c_Lqy3XxzW7IhILkhAnL3nLL
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_mH8HbNc3ozNB3YtNJjM7UU
          claim_id: c_aVHUtWbF2q4LNGNUGQ7485
          source_id: s_CgCY4ZD77hQPw8p4KmZirA
          stance: supports
          locator: Q697757
          quotation: null
...
relationships:
  ...
  children:
    ...
    - claim:
        ...
        current_revision: 2
      sources:
        - id: cs_5H16b7JrJ28qrERvg7FuSM
          claim_id: c_n3WPU49ceWqLHy5MojiQ8d
          source_id: s_1N4VHzGnSCazYyxcFVye5N
          stance: supports
          locator: 王引之条
          quotation: 王引之（1766—1834），王念孙之子。
          interpretation_note: null
          source:
            id: s_1N4VHzGnSCazYyxcFVye5N
            source_type: website
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王念孙，史料所见人物。本项目依据《王念孙》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
...
| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| parents | p_WJ1Fv3Xeybue8CK9VGrZL3 | 王安国 | accepted |
| children | p_gFYwpy3bwArweyiFAyfCzA | 王敬之 | accepted |
| children | p_Hvr19mPdS8JJV2kVGRPHJs | 王引之 | accepted |
