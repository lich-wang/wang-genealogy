  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_T6Sj1H7d9L79FYMngSRhcJ
          claim_id: c_bymAg33pDAJVxsKAwsquot
  ...
  - predicate: historical.period
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_pCqy9mFD6qs8GmuymAJPEg
          claim_id: c_VGvDRwUL3iLSHvy1AEh4uX
          source_id: s_zPYxEpH8gHaJEAKuT5R6M3
          stance: supports
          locator: 人物简介中的朝代／时期表述
          quotation: null
          interpretation_note: 从同一来源支持的简介摘取：东晋时期书法家、名士
          source:
            id: s_zPYxEpH8gHaJEAKuT5R6M3
            source_type: api_record
            title: 維基數據：王徽之（Q15928529）
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_YXiM8usgkC7A18vTNQK8WW
          claim_id: c_ev3AYfmC3uPs69VRGRmqp6
          source_id: s_zPYxEpH8gHaJEAKuT5R6M3
          stance: supports
          locator: Q15928529
          quotation: null
...
| children | p_eG5miLGWzg6mphbBUuSbNA | 王桢之 | accepted |
