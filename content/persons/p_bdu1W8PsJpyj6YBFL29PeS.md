...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_7Lf4ZWj7RoHyou8s5chYVD
        subject_person_id: p_bdu1W8PsJpyj6YBFL29PeS
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_DCJf5xRfiz338DPGMpSzpV
          claim_id: c_7Lf4ZWj7RoHyou8s5chYVD
          source_id: s_hqKcNiNwJ5Ef7qKS6mkic5
          stance: supports
          locator: CBDB:175947
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（175947）
          source: &a1
            id: s_hqKcNiNwJ5Ef7qKS6mkic5
            source_type: api_record
            title: 中国历代人物传记资料库：王超（CBDB 175947）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=175947&o=json
            external_identifier: CBDB:175947
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_s5rs3kcBAwTNaezwek1ax2
          claim_id: c_qQpZN373r64enkH3o1S6FV
          source_id: s_hqKcNiNwJ5Ef7qKS6mkic5
          stance: supports
          locator: null
          quotation: null
...
| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| parents | p_aak7BTbPT1FPBghTmKpiVW | 王收 | accepted |

## 外部来源

- [中国历代人物传记资料库：王超（CBDB 175947）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=175947&o=json)
