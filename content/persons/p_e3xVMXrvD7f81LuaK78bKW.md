  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_ExzuUqyPAKdqHLAdJBA8pv
          claim_id: c_ggU3ZYdLrDo1okeAcL3iJd
          source_id: s_brDB3HUKfuJfMmCz3kPVvw
          stance: supports
          locator: CBDB:232584
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（232584）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王舜弼，史料所见人物。本项目依据《中国历代人物传记资料库：王舜弼（CBDB 232584）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_5Prg10geCannBgh_T0LiNh
          claim_id: c_H7GKHia9P8dEH4ZqyQC4pS
          source_id: s_brDB3HUKfuJfMmCz3kPVvw
          stance: supports
          locator: CBDB:232584
          quotation: null
...
| bio.summary | 王舜弼，史料所见人物。本项目依据《中国历代人物传记资料库：王舜弼（CBDB 232584）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |

## 关联关系

| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| descendants | p_D7dK1u4GKLagJY81LcTNi5 | 王用謨 | accepted |
