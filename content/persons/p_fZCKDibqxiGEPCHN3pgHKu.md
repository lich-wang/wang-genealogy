...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_6or7V7MTXdh5wQDbgo8QK1
        subject_person_id: p_fZCKDibqxiGEPCHN3pgHKu
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_kFCZEZ8egWvcAvzVDPaZnk
          claim_id: c_6or7V7MTXdh5wQDbgo8QK1
          source_id: s_kioaNN46XxQssV2VBjYCrn
          stance: supports
          locator: CBDB:119757
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（119757）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王世文，史料所见人物。本项目依据《中国历代人物传记资料库：王世文（CBDB 119757）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_OCg-nRXILvNfHP84bJ7RXV
          claim_id: c_8ryKgMQcSw5Pqxc9qUXfbG
          source_id: s_kioaNN46XxQssV2VBjYCrn
          stance: supports
          locator: CBDB:119757
          quotation: null
...
| bio.summary | 王世文，史料所见人物。本项目依据《中国历代人物传记资料库：王世文（CBDB 119757）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
