  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王轼（1439年—1506年），天順進士。维基数据以独立条目 Q15912162 收录该人物；当前资料页据此确认其身份，其他生平细节仍待可靠史料补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王轼（1439年—1506年），天順進士。维基数据以独立条目 Q15912162 收录该人物；当前资料页据此确认其身份，其他生平细节仍待可靠史料补充。 | accepted |
