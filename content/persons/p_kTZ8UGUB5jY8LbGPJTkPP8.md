  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王國綱，史料所见人物。本项目依据《中国历代人物传记资料库：王國綱（CBDB 28620）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hant
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_9jD6vAqgxli7IpGh02b-EF
          claim_id: c_EB7NGGpL5u4wasLogxDQ8i
          source_id: s_88qcJBcBkjia3SY65rhn8Y
          stance: supports
          locator: CBDB:28620
          quotation: null
          interpretation_note: 自动补全人物基本介绍；身份由稳定外部标识锁定，信息来源层级为 source。
          source: &a1
            id: s_88qcJBcBkjia3SY65rhn8Y
            source_type: api_record
            title: 中国历代人物传记资料库：王國綱（CBDB 28620）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=28620&o=json
            external_identifier: CBDB:28620
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_FYY9zJ2smVPNknSMYMshSN
          claim_id: c_4HP9pK1iVjzJJo1bnP2E9i
          source_id: s_88qcJBcBkjia3SY65rhn8Y
          stance: supports
          locator: CBDB:28620
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王國綱，史料所见人物。本项目依据《中国历代人物传记资料库：王國綱（CBDB 28620）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王國綱 | accepted |
