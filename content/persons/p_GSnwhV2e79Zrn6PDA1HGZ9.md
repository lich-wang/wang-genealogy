  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王僎先（809年—833年），史料所见人物。本项目依据《中国历代人物传记资料库：王僎先（CBDB 143370）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_q3hwlLEWTZB0sMt6alTovx
          claim_id: c_e8wcEVKhsBPXzqYw8wzj9r
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_kYhA25uBXLfJs9sEVNDioq
          claim_id: c_thB3SoDceULcCLppuGSLgQ
          source_id: s_frVW779uD6kgQCJyJNXtiy
          stance: supports
          locator: CBDB:143370
          quotation: null
          interpretation_note: CBDB 2026-08-29 Luna 审核通过人物批量导入（401-500）｜历史性依据：CBDB 卒年 = 833
          source:
            id: s_frVW779uD6kgQCJyJNXtiy
            source_type: api_record
            title: 中国历代人物传记资料库：王僎先（CBDB 143370）
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_N67wTDQCY3S3wbEPqGNjPS
          claim_id: c_fA7zRV9f5nV8i2pGm5uwzn
          source_id: s_frVW779uD6kgQCJyJNXtiy
          stance: supports
          locator: CBDB:143370
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_98K1FdCjA2yJPta94pPqKP
          claim_id: c_pJ4vaPNYYMCQtDKkAg7mTk
          source_id: s_frVW779uD6kgQCJyJNXtiy
          stance: supports
          locator: CBDB:143370
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王僎先（809年—833年），史料所见人物。本项目依据《中国历代人物传记资料库：王僎先（CBDB 143370）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| birth.date | 809年 | accepted |
| death.date | 833年 | accepted |
| name.primary | 王僎先 | accepted |
...
| spouses | p_VQhc59sgwzZ7rzfQ9XSa2F | 段公慶 | accepted |
