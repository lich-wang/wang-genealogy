  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王用善（卒于1633年），明人物。籍贯南陽，入仕廩生。（中国历代人物传记资料库 CBDB 555051）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 7
...
relationships:
  ...
  other:
    - claim:
        id: c_CwSn3qqr54H4M94JuP5A3Y
        subject_person_id: p_2g8eFiW5qWaCBZY2FoNT5h
        claim_kind: relationship
        predicate: kinship.sibling_of
        object_person_id: p_BZTq4h8J9i4P7ewhfmoDT2
        generation_count: null
        parent_role: null
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_dL8syFMsQoJXaaw5STVr1j
          claim_id: c_CwSn3qqr54H4M94JuP5A3Y
          source_id: s_cXFA6xnhQUSqagW-oGRpcu
          stance: supports
          locator: CBDB 亲属：兄（KinPerson 555051 王用善）
          quotation: null
          interpretation_note: CBDB 记录的同辈兄弟姊妹关系，按字典序规范化存储。
          source:
            id: s_cXFA6xnhQUSqagW-oGRpcu
            source_type: api_record
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王用善（卒于1633年），明人物。籍贯南陽，入仕廩生。（中国历代人物传记资料库 CBDB 555051） | accepted |
...
| other | p_2g8eFiW5qWaCBZY2FoNT5h | 王用中 | accepted |
