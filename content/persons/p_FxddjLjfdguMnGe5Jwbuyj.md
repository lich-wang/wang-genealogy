  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王詢，明人物。明清進士進士，籍贯成都右衛，入仕進士，曾任巡撫。（中国历代人物传记资料库 CBDB 126740）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_FCYPmoXrjLG5xflTG3X_G9
...
relationships:
  ...
  ancestors:
    - claim:
        id: c_aiBwpd0KQA-ECJ_ogwZFbj
        subject_person_id: p_i4ZXqNFE9p5BDvLSib59Um
        claim_kind: relationship
        ...
        current_revision: 1
      sources:
        - id: cs_pVezqC2Zo7MCGTZ6OKQXWL
          claim_id: c_aiBwpd0KQA-ECJ_ogwZFbj
          source_id: s_jtB2jsbDGphEHAx74GqMGu
          stance: supports
          locator: 嘉靖二十三年登科錄:一卷，第二甲第六十名：曾孫; 重孫
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_jtB2jsbDGphEHAx74GqMGu
            source_type: api_record
            title: 中国历代人物传记资料库：王昱（CBDB 305871）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=305871&o=json
            external_identifier: CBDB:305871
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-09T00:03:19.745Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_i4ZXqNFE9p5BDvLSib59Um
        status: active
        display_name: 王昱
        merged_into_person_id: null
    - claim:
        id: c_ik263RwDETFa-6DWLdr1My
        subject_person_id: p_VVhupDpTRB7oYbPU9XdSLi
        claim_kind: relationship
        predicate: kinship.ancestor_of
        object_person_id: p_FxddjLjfdguMnGe5Jwbuyj
        generation_count: 2
        ...
        current_revision: 1
      sources:
        - id: cs_Kakrj4HgdhaQZjKawWi7iw
          claim_id: c_ik263RwDETFa-6DWLdr1My
          source_id: s_DJL37YnFNkwp3eE7Lvx8EJ
          stance: supports
          locator: 嘉靖二十三年登科錄:一卷，第二甲第六十名：孫
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_DJL37YnFNkwp3eE7Lvx8EJ
            source_type: api_record
            title: 中国历代人物传记资料库：王楠（CBDB 305873）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=305873&o=json
            external_identifier: CBDB:305873
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-09T00:03:19.746Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_VVhupDpTRB7oYbPU9XdSLi
        status: active
        display_name: 王楠
        merged_into_person_id: null
  descendants: []
...
| bio.summary | 王詢，明人物。明清進士進士，籍贯成都右衛，入仕進士，曾任巡撫。（中国历代人物传记资料库 CBDB 126740） | accepted |
