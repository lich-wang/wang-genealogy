...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_pJEY8gpZ9zBwoRvLmtk1DT
        subject_person_id: p_8fDrLw8VCGEdLrGRH6rJ4L
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_83ypTdoJxx89uFMaGs96Af
          claim_id: c_pJEY8gpZ9zBwoRvLmtk1DT
          source_id: s_qzquueJZC5F1zTvrukHtfi
          stance: supports
          locator: CBDB:175791
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（175791）
          source: &a1
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_ywMysroKsweSkyV3rSdjq7
          claim_id: c_W4A67ozRA26T7UW5RUzWN8
          source_id: s_qzquueJZC5F1zTvrukHtfi
          stance: supports
          locator: null
          quotation: null
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王懷讓（卒于715年），唐人物。籍贯丹徒，曾任州司倉參軍。（中国历代人物传记资料库 CBDB 175791）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_kCervHdlKhMHC-YTihLbOP
          claim_id: c_ccybAFKFoScC57Mze42jhp
          source_id: s_qzquueJZC5F1zTvrukHtfi
          stance: supports
          locator: CBDB:175791
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| name.primary | 王懷讓 | accepted |
| death.date | 715年 | accepted |
| bio.summary | 王懷讓（卒于715年），唐人物。籍贯丹徒，曾任州司倉參軍。（中国历代人物传记资料库 CBDB 175791） | accepted |
