...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_Qij6izVxRnbFKZ6VP4WP1n
        subject_person_id: p_Pe1XkKTkL3fcxwNbY3CDnt
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_NDFw4eU93tM2Le4wMizR6f
          claim_id: c_Qij6izVxRnbFKZ6VP4WP1n
          source_id: s_XLtp4fwpXHPNdERNaB6cwa
          stance: supports
          locator: CBDB:703963
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（703963）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王孚，明人物。籍贯山陰。（中国历代人物传记资料库 CBDB 703963）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_6saQllg903wsS28EGsLarI
          claim_id: c_f7ZJ6Q6VRTFhFgNekP2RwF
          source_id: s_XLtp4fwpXHPNdERNaB6cwa
          stance: supports
          locator: CBDB:703963
          quotation: null
...
| bio.summary | 王孚，明人物。籍贯山陰。（中国历代人物传记资料库 CBDB 703963） | accepted |

## 关联关系

| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| parents | p_ab4X6JMquciDShdbWud5tM | 王中元 | accepted |
