  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_FSWaa9YLJEGSNG9kefzwo2
          claim_id: c_TbaygaFbuULzhFQwzJVus4
          source_id: s_6Eop75xNkBiqMxEkN2G3vA
          stance: supports
          locator: CBDB:232522
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（232522）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王重光，史料所见人物。本项目依据《中国历代人物传记资料库：王重光（CBDB 232522）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_5R1ap7KabOsG0xMoTjXvbp
          claim_id: c_h4K8XgiC7XwquozLJ6nKww
          source_id: s_6Eop75xNkBiqMxEkN2G3vA
          stance: supports
          locator: CBDB:232522
          quotation: null
...
| bio.summary | 王重光，史料所见人物。本项目依据《中国历代人物传记资料库：王重光（CBDB 232522）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
