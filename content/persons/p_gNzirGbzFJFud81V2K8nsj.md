...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_Fg2KEzeiE2oBQKsLpGnPHq
        subject_person_id: p_gNzirGbzFJFud81V2K8nsj
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_ynTVQP25x3EpiUYp39GkyK
          claim_id: c_Fg2KEzeiE2oBQKsLpGnPHq
          source_id: s_6ZJkW3bXDwrWU3o1rgDqeN
          stance: supports
          locator: CBDB:317549
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（317549）
          source: &a1
            id: s_6ZJkW3bXDwrWU3o1rgDqeN
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王俊民，明人物。嘉靖三十二年進士，籍贯商丘。（中国历代人物传记资料库 CBDB 317549）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_w0pl2EerDMQG6kv-4NaujY
          claim_id: c_QdbQ2B8edmCZwFW9QYazks
          source_id: s_6ZJkW3bXDwrWU3o1rgDqeN
          stance: supports
          locator: CBDB:317549
          quotation: null
...
relationships:
  parents:
    - claim:
        ...
        current_revision: 1
      sources:
        - id: cs_GBUltH-sPFkn8-lae9arXN
          claim_id: c_wXumqtQJAc1ZT9gDwsqmnw
          source_id: s_cMaPWGZQNcyp0EUcoFbmTH
          stance: supports
          locator: CBDB：兄弟 王彥民（204329）之父／母 王宗周
          quotation: null
          interpretation_note: 由兄弟关系推断：王俊民 与 王彥民 为同胞（CBDB 记「弟」），王彥民 之父／母即 王俊民 之父／母。
          source:
...
| bio.summary | 王俊民，明人物。嘉靖三十二年進士，籍贯商丘。（中国历代人物传记资料库 CBDB 317549） | accepted |
