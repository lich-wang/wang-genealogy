  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_iHhBd219wDWPnjKK6fZ9dv
          claim_id: c_jGYD7v7FcWo3u4MGG6dLd7
          source_id: s_zFvdQLJtudRc3Lad4JHRUW
          stance: supports
          locator: CBDB:693029
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（693029）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: "王煦，清人物。籍贯元和，身份为為善鄉里、義民/義官，入仕學校: 生員(庠生)。（中国历代人物传记资料库 CBDB 693029）"
          language: zh-Hant
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_pO8e1hYoyGtM6XPKXqgzKx
          claim_id: c_Kg5tnJ1APMHYpSVs67Cs1o
          source_id: s_zFvdQLJtudRc3Lad4JHRUW
          stance: supports
          locator: CBDB:693029
          quotation: null
...
| bio.summary | 王煦，清人物。籍贯元和，身份为為善鄉里、義民/義官，入仕學校: 生員(庠生)。（中国历代人物传记资料库 CBDB 693029） | accepted |
...
| children | p_gpMSreZ1XGTxNvYMPuuB9t | 王兆辰 | accepted |
