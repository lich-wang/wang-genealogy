...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_WIJla_2JbjrJVFvQ-wNzzW
        subject_person_id: p_DDih3NoysRAaq63UWuEY6y
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王愷，史料所见人物。本项目依据《太原王氏》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 4
      sources:
        - id: cs_hE1Y_KAI06wwypz5ePY2U9
          claim_id: c_WIJla_2JbjrJVFvQ-wNzzW
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_Gr9h53NRPLNjBE8Q3K4DEU
          claim_id: c_hEBauBFEkbe89AZGdCycyH
          source_id: s_8v3HEWJMg8p43rd4zxNR9r
          stance: supports
          locator: Q30923862
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王愷，史料所见人物。本项目依据《太原王氏》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
