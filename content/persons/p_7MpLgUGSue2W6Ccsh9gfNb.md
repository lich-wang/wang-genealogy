  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王日就（1109年—1174年），宋人物。籍贯分水，身份为道士、地方士人/鄉紳。（中国历代人物传记资料库 CBDB 38137）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_mX3rWT4dxLpS8BbygTeHSG
...
relationships:
  ...
  children:
    ...
    - claim:
        id: c_9eXMfbbkbbQ2Pz6uJFO83P
        subject_person_id: p_7MpLgUGSue2W6Ccsh9gfNb
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_F4LCsnNgn78ANnjAvvzuWW
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_Xi2UX9s9_GRFUTOQZwmPMx
          claim_id: c_9eXMfbbkbbQ2Pz6uJFO83P
          source_id: s_b_AHqcoTAAirggVd85l4LZ
          stance: supports
          locator: CBDB 亲属：父（KinPerson 38137）
          quotation: null
          interpretation_note: CBDB 直接记录的父／母关系。
          source:
            id: s_b_AHqcoTAAirggVd85l4LZ
            source_type: api_record
...
| bio.summary | 王日就（1109年—1174年），宋人物。籍贯分水，身份为道士、地方士人/鄉紳。（中国历代人物传记资料库 CBDB 38137） | accepted |
...
| children | p_F4LCsnNgn78ANnjAvvzuWW | 王琪 | accepted |
