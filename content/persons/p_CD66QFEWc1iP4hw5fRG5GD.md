  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王原格，明人物。嘉靖四十一年進士，籍贯番禺。（中国历代人物传记资料库 CBDB 327871）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 7
      sources:
        - id: cs__1aqLzjkkFy_BWP5r4jfph
          claim_id: c_DqoiKBY7ERsbsUJPuG6dia
          source_id: s_ADR3pUWzFNR7zjCkkb2MLZ
          stance: supports
          locator: CBDB:327871
          quotation: null
          interpretation_note: 自动补全人物基本介绍；身份由稳定外部标识锁定，信息来源层级为 cbdb。
          source: &a1
            id: s_ADR3pUWzFNR7zjCkkb2MLZ
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_HcJZj98zC7m7PggCfGEL32
          claim_id: c_7TP4YNqa8GEejUpEJLZhoU
          source_id: s_ADR3pUWzFNR7zjCkkb2MLZ
          stance: supports
          locator: CBDB:327871
          quotation: null
...
relationships:
  parents:
    - claim:
        id: c_DfrQloEDfsCnzD0oUeav9A
        subject_person_id: p_2ER4qeybN68kj6wmWDD4De
        claim_kind: relationship
        predicate: kinship.parent_of
        object_person_id: p_CD66QFEWc1iP4hw5fRG5GD
        generation_count: null
        parent_role: null
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_md8oRmEBIz1xxj4-COt5L9
          claim_id: c_DfrQloEDfsCnzD0oUeav9A
          source_id: s_KKRpWrdg7hhgj1S76c1yak
          stance: supports
          locator: CBDB：兄弟 王原相（205067）之父／母 王渐逵
          quotation: null
          interpretation_note: 由兄弟关系推断：王原格 与 王原相 为同胞（CBDB 记「弟」），王原相 之父／母即 王原格 之父／母。
          source:
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王原格，明人物。嘉靖四十一年進士，籍贯番禺。（中国历代人物传记资料库 CBDB 327871） | accepted |
| name.primary | 王原格 | accepted |
