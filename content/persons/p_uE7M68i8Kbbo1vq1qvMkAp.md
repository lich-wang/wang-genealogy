...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_i1j4YApXsgBAyim3dvgnOG
        subject_person_id: p_uE7M68i8Kbbo1vq1qvMkAp
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王瑜，史料所见人物。本项目依据《琅邪王氏》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_bg8hc_OoLjljG5k_pOVaHO
          claim_id: c_i1j4YApXsgBAyim3dvgnOG
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_WJT6e9soWk4cKLj8G7LD4v
          claim_id: c_SaJfnQ8bsQUu6EJnrxQfwc
          source_id: s_3Q66jhvLbAGSzPLRaQhwaV
          stance: supports
          locator: CBDB:null
          quotation: null
...
relationships:
  parents:
    - claim:
        id: c_72xnML2YBWixGs9N8pedAR
        subject_person_id: p_5Xg43MeoSc4vLaZEiTQBL1
        claim_kind: relationship
        predicate: kinship.parent_of
        object_person_id: p_uE7M68i8Kbbo1vq1qvMkAp
        generation_count: null
        parent_role: null
        value_json: null
        status: accepted
        ...
        current_revision: 2
      sources:
        - id: cs_fUcYT54Fpv27o3eGNc2SCS
          claim_id: c_72xnML2YBWixGs9N8pedAR
        ...
        - id: cs_BxD9zrKcAWdgcxuMdPSFVT
          ...
          source:
            ...
            metadata_json: null
        - id: cs_aBSmJNa41HKqGQKkHj6oYj
          claim_id: c_72xnML2YBWixGs9N8pedAR
          source_id: s_MGBoig692jprej3f8uiDi2
          stance: supports
          locator: 条文：世系圖
          quotation: 琅邪王氏世系圖 世系圖：王含 → 王瑜
          interpretation_note: null
          source:
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王瑜，史料所见人物。本项目依据《琅邪王氏》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
