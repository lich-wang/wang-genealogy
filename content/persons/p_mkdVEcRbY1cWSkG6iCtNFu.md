...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_jQLTfinkgLCKnAgPhUbPcD
        subject_person_id: p_mkdVEcRbY1cWSkG6iCtNFu
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王穡，史料所见人物。本项目依据《中国历代人物传记资料库：王穡（CBDB 437550）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_x0O6SgcpzC1XoI2Y9Srq4P
          claim_id: c_jQLTfinkgLCKnAgPhUbPcD
          source_id: s_ymVLvM78JhE5csQtgr2qYQ
          stance: supports
          locator: CBDB:437550
          quotation: null
          interpretation_note: 自动补全人物基本介绍；身份由稳定外部标识锁定，信息来源层级为 source。
          source: &a1
            id: s_ymVLvM78JhE5csQtgr2qYQ
            source_type: api_record
            title: 中国历代人物传记资料库：王穡（CBDB 437550）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=437550&o=json
            external_identifier: CBDB:437550
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_c8N2hcM8xdtGCRGqmjGCrx
          claim_id: c_VHZFaP7dgBQdsXcVQ7cdZs
          source_id: s_ymVLvM78JhE5csQtgr2qYQ
          stance: supports
          locator: CBDB:437550
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王穡，史料所见人物。本项目依据《中国历代人物传记资料库：王穡（CBDB 437550）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王穡 | accepted |
...
- [中国历代人物传记资料库：王穡（CBDB 437550）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=437550&o=json)
