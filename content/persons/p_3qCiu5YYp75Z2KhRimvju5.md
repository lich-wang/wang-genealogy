  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王渷，史料所见人物。本项目依据《中国历代人物传记资料库：王渷（CBDB 437564）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_CNidPscqQt1u8yeQuvE3Dp
          claim_id: c_odN79DhtjsAaLRq7op9HXn
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_FFNb8EgaReHKiozm3PHWWF
          claim_id: c_UK2ojNduh8GFJhx3KHJMxF
          source_id: s_LPrkn5UgY6DTvwHSBFgGQR
          stance: supports
          locator: CBDB:437564
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王渷，史料所见人物。本项目依据《中国历代人物传记资料库：王渷（CBDB 437564）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王渷 | accepted |
