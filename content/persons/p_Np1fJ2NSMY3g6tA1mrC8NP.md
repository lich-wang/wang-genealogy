  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王添成，史料所见人物。本项目依据《中国历代人物传记资料库：王添成（CBDB 280633）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_lKnlRy7hsSlpaIgxedhBtj
          claim_id: c_a9Fp4K4CwpAA8R9j8JLvEQ
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_uJv4Ec4rBNNMC5G43YvC3K
          claim_id: c_zWf2VphuHMS1bM2jtxMEgo
          source_id: s_brbr5hLAQjvmPthNF6noLQ
          stance: supports
          locator: CBDB:280633
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王添成，史料所见人物。本项目依据《中国历代人物传记资料库：王添成（CBDB 280633）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王添成 | accepted |
