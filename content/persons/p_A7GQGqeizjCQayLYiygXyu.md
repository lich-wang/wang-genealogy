...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_dPLXiFaFEg3DNDfAaap5Xj
        subject_person_id: p_A7GQGqeizjCQayLYiygXyu
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_MhKdkp1HcagFtJViusd7Wb
          claim_id: c_dPLXiFaFEg3DNDfAaap5Xj
          source_id: s_jC2po3niD88mnSLhvM8SqR
          stance: supports
          locator: CBDB:526926
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（526926）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王世鈞，史料所见人物。本项目依据《中国历代人物传记资料库：王世鈞（CBDB 526926）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_WVZwia-Yznd47gzkjHlz_3
          claim_id: c_QsPW5uN7Z7kyy7my9cD7GU
          source_id: s_jC2po3niD88mnSLhvM8SqR
          stance: supports
          locator: CBDB:526926
          quotation: null
...
| bio.summary | 王世鈞，史料所见人物。本项目依据《中国历代人物传记资料库：王世鈞（CBDB 526926）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
