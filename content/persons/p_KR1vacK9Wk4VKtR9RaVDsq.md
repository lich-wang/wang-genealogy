...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_NfwPqoEYAFSqjJHukQQkMt
        subject_person_id: p_KR1vacK9Wk4VKtR9RaVDsq
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_9E4vgZNLSCnmDDxMYUQjdM
          claim_id: c_NfwPqoEYAFSqjJHukQQkMt
          source_id: s_ExpHz1NuXCpaadn6e6p8Er
          stance: supports
          locator: CBDB:28623
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（28623）
          source: &a1
            id: s_ExpHz1NuXCpaadn6e6p8Er
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王洙，元人物。籍贯真定。（中国历代人物传记资料库 CBDB 28623）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_bb_WVArmTHQTYQ8U5gLWqM
          claim_id: c_mMp98UWtHKPPmZ97HHefN2
          source_id: s_ExpHz1NuXCpaadn6e6p8Er
          stance: supports
          locator: CBDB:28623
          quotation: null
...
| bio.summary | 王洙，元人物。籍贯真定。（中国历代人物传记资料库 CBDB 28623） | accepted |
