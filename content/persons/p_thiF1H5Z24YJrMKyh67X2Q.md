  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王寶（卒于830年），史料所见人物。本项目依据《中国历代人物传记资料库：王寶（CBDB 185730）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_VLBDPms_GXg13eyKLL8zj8
  ...
  children:
    - claim:
      ...
      object_person:
        ...
        merged_into_person_id: null
    - claim:
        id: c_fEOfpiEBZHH30x6BLy4wFj
        subject_person_id: p_thiF1H5Z24YJrMKyh67X2Q
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_FdFSWk14dHFi4MyAUsTZBR
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_DZMhlNnV5MnWoXEN28nQ9s
          claim_id: c_fEOfpiEBZHH30x6BLy4wFj
      ...
      object_person:
        ...
        merged_into_person_id: null
    - claim:
        id: c_pn3GKrWrVsOVejRT5kMd6K
        subject_person_id: p_thiF1H5Z24YJrMKyh67X2Q
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_xeN1h4w9bFQAo1hiSmCjrE
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_lZkMe2H7cUFvb9UGZlOdiF
          claim_id: c_pn3GKrWrVsOVejRT5kMd6K
          source_id: s_ycUbj2yxmqfDh8JSWMDzit
          stance: supports
          locator: 唐五代人物傳記與社會網絡資料庫(1.0版)：父
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_ycUbj2yxmqfDh8JSWMDzit
            source_type: api_record
            title: 中国历代人物传记资料库：王庥（CBDB 186091）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=186091&o=json
            external_identifier: CBDB:186091
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-08T23:54:04.267Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_xeN1h4w9bFQAo1hiSmCjrE
        status: active
        display_name: 王庥
        merged_into_person_id: null
    - claim:
        id: c_aRmqZUZ2V599PH4i-m69t4
        subject_person_id: p_thiF1H5Z24YJrMKyh67X2Q
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_zCoF7Qyk8qXrh8U432U9id
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_noT-HPk-51TaLU-8MU4sau
          claim_id: c_aRmqZUZ2V599PH4i-m69t4
          source_id: s_YEHhYZxgGby7RTiUhQFHCf
          stance: supports
          locator: 唐五代人物傳記與社會網絡資料庫(1.0版)：父
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_YEHhYZxgGby7RTiUhQFHCf
            source_type: api_record
            title: 中国历代人物传记资料库：王彥（CBDB 186092）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=186092&o=json
            external_identifier: CBDB:186092
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-09T00:03:16.255Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_zCoF7Qyk8qXrh8U432U9id
        status: active
        display_name: 王彥
        merged_into_person_id: null
  adoptive_parents: []
...
| bio.summary | 王寶（卒于830年），史料所见人物。本项目依据《中国历代人物传记资料库：王寶（CBDB 185730）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
...
| children | p_FdFSWk14dHFi4MyAUsTZBR | 王膺 | accepted |
| children | p_xeN1h4w9bFQAo1hiSmCjrE | 王庥 | accepted |
| children | p_zCoF7Qyk8qXrh8U432U9id | 王彥 | accepted |
...
- [中国历代人物传记资料库：王庥（CBDB 186091）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=186091&o=json)
- [中国历代人物传记资料库：王彥（CBDB 186092）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=186092&o=json)
