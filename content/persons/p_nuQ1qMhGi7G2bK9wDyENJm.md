  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王元深，史料所见人物。本项目依据《王寵惠》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 4
      sources:
        - id: cs_4owL9SlwXPJLOI49txDG9W
          claim_id: c_r45vP9lJtIYYhzxhP9NKCE
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_N86GWUHE92xXNoTxMHVz77
          claim_id: c_UWX3Nen7AQjh1FHkychoT9
          source_id: s_PsJf2my4WM4CeXcQju7yMx
          stance: supports
          locator: CBDB:null
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王元深，史料所见人物。本项目依据《王寵惠》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王元深 | accepted |

## 关联关系

| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| descendants | p_S19Wsq1aN5wyApGxSWWoLb | 王寵惠 | accepted |
