...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_4UHRuNUcvP6hMet8ep8BzJ
        subject_person_id: p_Xqpg7m72CbMAmY8AUfiCmv
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_Dj9GFghNXhQrvUV3P5dSw2
          claim_id: c_4UHRuNUcvP6hMet8ep8BzJ
          source_id: s_ks8ZBBjy7CNyzQy3zQZJoH
          stance: supports
          locator: CBDB:190170
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（190170）
          source: &a1
            id: s_ks8ZBBjy7CNyzQy3zQZJoH
            source_type: api_record
            title: 中国历代人物传记资料库：王温（CBDB 190170）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=190170&o=json
            external_identifier: CBDB:190170
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 1
      sources:
        - id: cs_vKv7hFyJyWwLjGLFvvmhk9
          claim_id: c_XULc2ZFo1zjLEVAnFP3m1C
          source_id: s_ks8ZBBjy7CNyzQy3zQZJoH
          stance: supports
          locator: null
          quotation: null
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王温（卒于985年），五代人物。籍贯建州。（中国历代人物传记资料库 CBDB 190170）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_Dikkdz3SC30isyMssyhUs8
          claim_id: c_6iCFvHFYgkHJWPve4cJdCC
          source_id: s_ks8ZBBjy7CNyzQy3zQZJoH
          stance: supports
          locator: CBDB:190170
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| name.primary | 王温 | accepted |
| death.date | 985年 | accepted |
| bio.summary | 王温（卒于985年），五代人物。籍贯建州。（中国历代人物传记资料库 CBDB 190170） | accepted |
