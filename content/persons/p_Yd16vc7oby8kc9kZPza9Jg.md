...
relationships:
  parents:
    - claim:
        id: c_Wr-g5gARtMBCxGuwxRDqbt
        subject_person_id: p_wsFAVGfuKix48GNXEaitKt
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_Yd16vc7oby8kc9kZPza9Jg
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_bYVy25Z304yLJplpLkaY1W
          claim_id: c_Wr-g5gARtMBCxGuwxRDqbt
          source_id: s_ysfZzynM--MQtVjDxcW3QQ
          stance: supports
          locator: CBDB 亲属：父（KinPerson 37984）
          quotation: null
          interpretation_note: CBDB 直接记录的父／母关系。
          source:
            id: s_ysfZzynM--MQtVjDxcW3QQ
            source_type: api_record
            title: 中国历代人物传记资料库：王肅（CBDB 563233）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
