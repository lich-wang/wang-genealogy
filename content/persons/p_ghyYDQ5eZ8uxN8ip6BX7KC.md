  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王原相（1535年—？），字召之，號鵬江，廣東廣州府番禺縣人，民籍，明朝政治人物。
          language: zh-Hant
        status: accepted
        confidence: medium
        current_revision: 5
      sources:
        - id: cs_UZQU733NKBLHFcJit5zDAh
          claim_id: c_YvGyawfshKd43VARAopwcL
        ...
        - id: cs_MJc05vLE3RP2L8zoshc7sD
          claim_id: c_YvGyawfshKd43VARAopwcL
          source_id: s_TWLEAiaYj03KSK4igwa5Mb
          stance: supports
          locator: 导言
          quotation: 王原相（1535年—？），字召之，號鵬江，廣東廣州府番禺縣人，民
          interpretation_note: 自动补全人物基本介绍；身份由稳定外部标识锁定，信息来源层级为 wikipedia。
          source:
            id: s_TWLEAiaYj03KSK4igwa5Mb
            source_type: website
            title: 中文维基百科：王原相
            creator: 维基百科贡献者
            publisher: Wikimedia Foundation
            published_at_text: null
            canonical_url: https://zh.wikipedia.org/wiki/%E7%8E%8B%E5%8E%9F%E7%9B%B8
            external_identifier: Q45551627
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_WE9j6PdWHX2ywSpxZC2L4B
          claim_id: c_JLS6AA8XxTvN7B2s3Q3pL2
          source_id: s_dXQa8yj97rf6Qh1MERKn2v
          stance: supports
          locator: null
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_LRoCya9ra9MUkYxbCVBDSK
          claim_id: c_FgqaPuAwKKECmB2ayePXHj
          source_id: s_dXQa8yj97rf6Qh1MERKn2v
          stance: supports
          locator: Q45551627
          quotation: null
...
relationships:
  parents:
    - claim:
        ...
        current_revision: 2
      sources:
        - id: cs_92i6GFRWsFGm6Fx5MNcttp
          claim_id: c_LkDhzVjPmDy5b772cVTw4X
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王原相（1535年—？），字召之，號鵬江，廣東廣州府番禺縣人，民籍，明朝政治人物。 | accepted |
| birth.date | 1535年 | accepted |
| name.primary | 王原相 | accepted |
