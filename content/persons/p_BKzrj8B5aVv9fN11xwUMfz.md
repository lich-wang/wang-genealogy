  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王性安，史料所见人物。本项目依据《中国历代人物传记资料库：王性安（CBDB 281307）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_dyUfDJYHWrkS-BoHL0YUIr
          claim_id: c_kKSvnn5v2WK7VQZDWFa3CR
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_zGw8YELGiX4wnwSFVV7hBS
          claim_id: c_S3vs2qsorKtbMA8FtXQRx2
          source_id: s_uootp3154BBti6HcA37Mwi
          stance: supports
          locator: CBDB:281307
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王性安，史料所见人物。本项目依据《中国历代人物传记资料库：王性安（CBDB 281307）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王性安 | accepted |
