  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王盧（生于1424年），明人物。明清進士進士，籍贯閩縣，入仕進士。（中国历代人物传记资料库 CBDB 198449）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 7
...
relationships:
  ...
  other:
    ...
    - claim:
        ...
        current_revision: 1
      sources:
        - id: cs_auUIK5j6Xx7RCkv5jWoxNe
          claim_id: c_-SDa6aiiVT1_gvvX8GoAF2
          source_id: s_anlu_u9C2o3QoV72LyrmO9
          stance: supports
          locator: CBDB 亲属：弟（KinPerson 198449 王盧）
          quotation: null
          interpretation_note: CBDB 记录的同辈兄弟姊妹关系，按字典序规范化存储。
          source:
    ...
    - claim:
        ...
        current_revision: 1
      sources:
        - id: cs_892izHmdfigfYzafCuRGYx
          claim_id: c_6deNXBJ2SypA1W-GR1xk88
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王盧（生于1424年），明人物。明清進士進士，籍贯閩縣，入仕進士。（中国历代人物传记资料库 CBDB 198449） | accepted |
...
| other | p_9trnTxMJH6XbK8DNVRiQvo | 王鏈 | accepted |
| other | p_MmttuErUT2T1qBa2PZf2xq | 王錞 | accepted |
| other | p_ScLXmLf2o1TeTAygM8y8wC | 王康 | accepted |
| other | p_VrERyQJSNSaviohGQW1ath | 王錦 | accepted |
