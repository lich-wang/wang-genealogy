...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_efxYFr4r9g84jKPKLrJKCw
        subject_person_id: p_7UtRMxAfbFv3b7QhMfYg8M
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_jEf9itGqeVjvdFoJvfjE6c
          claim_id: c_efxYFr4r9g84jKPKLrJKCw
          source_id: s_yfSPwWUQKSm2KfxSMWGVBD
          stance: supports
          locator: CBDB:150497
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（150497）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王安定，史料所见人物。本项目依据《中国历代人物传记资料库：王安定（CBDB 150497）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_F1HNvPOkwCdeuikpu6fMyv
          claim_id: c_tXha86jz8nzYDc7KoPpPRc
          source_id: s_yfSPwWUQKSm2KfxSMWGVBD
          stance: supports
          locator: CBDB:150497
          quotation: null
...
| bio.summary | 王安定，史料所见人物。本项目依据《中国历代人物传记资料库：王安定（CBDB 150497）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
