  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王孟德，史料所见人物。本项目依据《中国历代人物传记资料库：王孟德（CBDB 279496）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_k3JOTh3-RdnqWNiplDsz1_
          claim_id: c_jUvLYbdPzpszbdhV7a3kAe
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_uJNmMuVXYQsNWNp69seJfE
          claim_id: c_4jWjZmtMXj5FkGurJaVNND
          source_id: s_xrn8BFdA4MCd94LrUD5zZB
          stance: supports
          locator: CBDB:279496
          quotation: null
...
relationships:
  ...
  descendants:
    ...
    - claim:
        ...
        current_revision: 1
      sources:
        - id: cs_HtJgVM8tkhGcd-rM-QMKs0
          claim_id: c_5rCySGojG6Ime2FAm93BYH
          source_id: s_xrn8BFdA4MCd94LrUD5zZB
          stance: supports
          locator: 正德十二年進士登科錄:一卷，第二甲第十二名：曾孫; 重孫
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source: *a2
      object_person:
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王孟德，史料所见人物。本项目依据《中国历代人物传记资料库：王孟德（CBDB 279496）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王孟德 | accepted |
