  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王友亮（1742年—1797年），史料所见人物。本项目依据《中国历代人物传记资料库：王友亮（CBDB 58603）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_XZ-1Rl2SGaqG0WXPZt5ufc
          claim_id: c_dhdXH3WWhCsHLENMYy8iau
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_apwToGVWiiNDFBZDqupRQR
          claim_id: c_qUzQ5vwwqu7GoLNQyXWHSA
          source_id: s_NUj526A7RkfPNCRdD3geau
          stance: supports
          locator: CBDB:58603
          quotation: null
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_YsMHMxpTKBtpuqQv1ALinR
          claim_id: c_TUGhPit66Wh5RvK9wXv6vb
          source_id: s_NUj526A7RkfPNCRdD3geau
          stance: supports
          locator: CBDB:58603
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_7NzUeCs3j8EVzarcpADmMb
          claim_id: c_Hk24hsStzUjWW4PLnG3ugj
          source_id: s_NUj526A7RkfPNCRdD3geau
          stance: supports
          locator: CBDB:58603
          quotation: null
...
relationships:
  ...
  children:
    - claim:
        ...
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_a3Z77DL9GxcG2NAvX5dG2G
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_4hYusaGYJ9jqSP9xtjeKVJ
          claim_id: c_9oZIAqF8CB0_BArxstbkd0
          source_id: s_LM42CMGEiDKdgt8DFCN761
          stance: supports
          locator: 人名權威資料（中央研究院歷史語言研究所），1863：父
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_LM42CMGEiDKdgt8DFCN761
            source_type: api_record
            title: 中国历代人物传记资料库：王行恕（CBDB 517395）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=517395&o=json
            external_identifier: CBDB:517395
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-06T01:18:16.852Z
            metadata_json:
              source_release: CBDB 2026-08-29
      object_person:
        id: p_a3Z77DL9GxcG2NAvX5dG2G
        status: active
        display_name: 王行恕
        merged_into_person_id: null
    - claim:
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王友亮（1742年—1797年），史料所见人物。本项目依据《中国历代人物传记资料库：王友亮（CBDB 58603）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| birth.date | 1742年 | accepted |
| death.date | 1797年 | accepted |
| name.primary | 王友亮 | accepted |
