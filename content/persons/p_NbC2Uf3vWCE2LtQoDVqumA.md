  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王华（1446年—1522年），字德辉，号龍山、实庵，晚号海日翁，浙江余姚人，是明朝狀元、政治人物，官至南京吏部尚書。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 3
      sources:
        - id: cs_YEUo2fK3W9dfWG8rSxi3vH
          claim_id: c_1Lw14Y7pPK5dKcVbEhqFqP
        ...
        - id: cs_cCz4gCQunftUZ8G9kMPn2L
          claim_id: c_1Lw14Y7pPK5dKcVbEhqFqP
          source_id: s_PCDo2e4nptVx59cF1FkmCz
          stance: supports
          locator: 导言
          quotation: 明朝狀元，政治人物
          interpretation_note: 据人物条目导言概括生卒、籍贯与身份。
          source:
            id: s_PCDo2e4nptVx59cF1FkmCz
            source_type: website
            title: 中文维基百科：王华（明朝）
            creator: 维基百科贡献者
            publisher: Wikimedia Foundation
            published_at_text: null
            canonical_url: https://zh.wikipedia.org/wiki/%E7%8E%8B%E5%8D%8E_(%E6%98%8E%E6%9C%9D)
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_LUbEYk22FewBQUbssbi7LS
          claim_id: c_V2zimFADbj33TnEdYHBiXG
          source_id: s_MS8MKyScQ3U4ija1uLMsVk
          stance: supports
          locator: Q15924849
          quotation: null
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_C152W59xNBjvGoFKqFCQkB
          claim_id: c_gUjkS44hYbs7D7ypTjg2PP
          source_id: s_MS8MKyScQ3U4ija1uLMsVk
          stance: supports
          locator: Q15924849
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_dcRRoYgbLNQrDwiBBDQ1V4
          claim_id: c_HQKWgyD6CWYG6vMJtqSSJV
          source_id: s_MS8MKyScQ3U4ija1uLMsVk
          stance: supports
          locator: Q15924849
          quotation: null
...
relationships:
  ...
  descendants:
    - claim:
        id: c_CqpYZpja15sKcy31ioxzsX
        subject_person_id: p_NbC2Uf3vWCE2LtQoDVqumA
        claim_kind: relationship
        predicate: kinship.ancestor_of
        object_person_id: p_HcLcok4Km76wcGcxiwtaL6
        generation_count: null
        parent_role: null
        value_json: null
        status: accepted
        ...
        current_revision: 2
      sources:
        - id: cs_vbE3n1yarmKRL8gpNQEEMW
          claim_id: c_CqpYZpja15sKcy31ioxzsX
          source_id: s_49jwMEQRnVkLiYLBG5wBiq
          stance: supports
          locator: 条文：条文识读（孙）（2世）
          quotation: 王华之孙
          interpretation_note: null
          source:
            id: s_49jwMEQRnVkLiYLBG5wBiq
            source_type: website
            title: 中文维基百科：王终
            creator: 维基百科贡献者
            publisher: Wikimedia Foundation
            published_at_text: null
            canonical_url: https://zh.wikipedia.org/wiki/%E7%8E%8B%E7%BB%88
            external_identifier: null
            license_code: CC-BY-SA-4.0
            accessed_at: 2026-08-25T02:41:48.355Z
            metadata_json: null
      object_person:
        id: p_HcLcok4Km76wcGcxiwtaL6
        status: active
        display_name: 王终
        merged_into_person_id: null
  other: []
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王华（1446年—1522年），字德辉，号龍山、实庵，晚号海日翁，浙江余姚人，是明朝狀元、政治人物，官至南京吏部尚書。 | accepted |
| birth.date | 1446年 | accepted |
| death.date | 1522年 | accepted |
| name.primary | 王华 | accepted |
...
| children | p_TQiMhGLRXGBc7HWBFHEr7P | 王守仁 | accepted |
| children | p_EfTsBpTgDdGmeng5EjD8V4 | 王守文 | accepted |
| children | p_vJKa8F6rABvMFQHxkgJBki | 王守俭 | accepted |
| spouses | p_LU5jkSTMukTW7wvUjdEEj8 | 郑氏 | accepted |
| descendants | p_HcLcok4Km76wcGcxiwtaL6 | 王终 | accepted |
...
- [中文维基百科：王华（明朝）](https://zh.wikipedia.org/wiki/%E7%8E%8B%E5%8D%8E_(%E6%98%8E%E6%9C%9D))
- [中文维基百科：王守仁](https://zh.wikipedia.org/wiki/王守仁)
- [中文维基百科：王终](https://zh.wikipedia.org/wiki/%E7%8E%8B%E7%BB%88)
