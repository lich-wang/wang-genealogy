...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_tYYXFKXujRawcncGPizF2r
        subject_person_id: p_KAQNKx6sKmt7hEpQcdXHS2
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王簡能，史料所见人物。本项目依据《中国历代人物传记资料库：王簡能（CBDB 157705）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_XmAcADPzLa8ZpRj4V3A2xS
          claim_id: c_tYYXFKXujRawcncGPizF2r
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_9E9Cb8QernKD72oJ6uxwv5
          claim_id: c_R1YgF13Mq8JwPBZhwQTgZe
          source_id: s_LogN1TGrQ1GK2oyJbAP1QC
          stance: supports
          locator: CBDB:157705
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王簡能，史料所见人物。本项目依据《中国历代人物传记资料库：王簡能（CBDB 157705）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王簡能 | accepted |
