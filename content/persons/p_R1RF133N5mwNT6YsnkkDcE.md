  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王仲堪（734年—797年），唐人物。中国历代人物传记资料库（CBDB）以人物编号 141326 收录其独立传记记录；未列明的生平细节仍待可靠史料补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 5
      sources:
        - id: cs_SyW-kZDMFT_La5AYKTbOza
          claim_id: c_udEwmYuUQCrnzEaqw7pzjL
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_epsKKPgkQumoLjkw8KFJNy
          claim_id: c_B1m9q56Q8LvXHNP9yNZNxa
          source_id: s_rErY2LTTPyhEcZTnzj5Up6
          stance: supports
          locator: CBDB:141326
          quotation: null
          interpretation_note: CBDB 2026-08-29 Luna 审核通过人物批量导入（401-500）｜历史性依据：CBDB 卒年 = 797
          source:
            id: s_rErY2LTTPyhEcZTnzj5Up6
            source_type: api_record
            title: 中国历代人物传记资料库：王仲堪（CBDB 141326）
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_iWuTApyZTRXixVnvGcAb4r
          claim_id: c_PAJeZBWGH11Fn186uiggBZ
          source_id: s_rErY2LTTPyhEcZTnzj5Up6
          stance: supports
          locator: CBDB:141326
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_kAz4vNfgpuGwhCAZoN84E1
          claim_id: c_1dZDgjHa3wAN3UZG4yAdXv
          source_id: s_rErY2LTTPyhEcZTnzj5Up6
          stance: supports
          locator: CBDB:141326
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王仲堪（734年—797年），唐人物。中国历代人物传记资料库（CBDB）以人物编号 141326 收录其独立传记记录；未列明的生平细节仍待可靠史料补充。 | accepted |
| birth.date | 734年 | accepted |
| death.date | 797年 | accepted |
| name.primary | 王仲堪 | accepted |
