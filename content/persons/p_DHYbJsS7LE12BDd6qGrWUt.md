  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王蒔蘭，史料所见人物。本项目依据《中国历代人物传记资料库：王蒔蘭（CBDB 69391）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
  ...
  descendants:
    ...
    - claim:
      ...
      object_person:
        ...
        merged_into_person_id: null
    - claim:
        id: c_t2ckKJa4WsKmOCj_vT88i-
        subject_person_id: p_DHYbJsS7LE12BDd6qGrWUt
        claim_kind: relationship
        predicate: kinship.ancestor_of
        object_person_id: p_svvpM1nLr4xeAvFYFUhNet
        generation_count: 2
        parent_role: null
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs__nEeUY0df5Jko3JWUbbBoh
          claim_id: c_t2ckKJa4WsKmOCj_vT88i-
          source_id: s_pJzLMkVFJDE1cpHofkfGnu
          stance: supports
          locator: 人名權威資料（中央研究院歷史語言研究所），13096：祖父
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_pJzLMkVFJDE1cpHofkfGnu
            source_type: api_record
            title: 中国历代人物传记资料库：王世聰（CBDB 526928）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=526928&o=json
            external_identifier: CBDB:526928
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-08T23:54:04.305Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_svvpM1nLr4xeAvFYFUhNet
        status: active
        display_name: 王世聰
        merged_into_person_id: null
    - claim:
      ...
      object_person:
        ...
        merged_into_person_id: null
    - claim:
        id: c_F8aIJbPkp__Ma9GA5yFdXS
        subject_person_id: p_DHYbJsS7LE12BDd6qGrWUt
        claim_kind: relationship
        predicate: kinship.ancestor_of
        object_person_id: p_jVG5KkEscuotxaT4Dgs1M7
        generation_count: 2
        parent_role: null
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_XVjcQligt6fMUYSqoGBfZg
          claim_id: c_F8aIJbPkp__Ma9GA5yFdXS
          source_id: s_8Qa3VR58U7497bQMY2hG2A
          stance: supports
          locator: 人名權威資料（中央研究院歷史語言研究所），13096：祖父
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_8Qa3VR58U7497bQMY2hG2A
            source_type: api_record
            title: 中国历代人物传记资料库：王乃祜（CBDB 526919）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=526919&o=json
            external_identifier: CBDB:526919
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-06T01:18:19.665Z
            metadata_json:
              source_release: CBDB 2026-08-29
      object_person:
        id: p_jVG5KkEscuotxaT4Dgs1M7
        status: active
        display_name: 王乃祜
        merged_into_person_id: null
  other: []
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王蒔蘭，史料所见人物。本项目依据《中国历代人物传记资料库：王蒔蘭（CBDB 69391）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
...
| descendants | p_jVG5KkEscuotxaT4Dgs1M7 | 王乃祜 | accepted |
...
- [中国历代人物传记资料库：王乃祜（CBDB 526919）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=526919&o=json)
