  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王大合（生于1568年），明人物。入仕進士。（中国历代人物传记资料库 CBDB 207604）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_JQAYSHUH2_qWeGxqbCqxfi
...
relationships:
  parents:
    - claim:
        id: c_CruOTXwGSCRmT0sZDIct2R
        subject_person_id: p_L1Hr72ZKdktC6H481ZmUUG
        ...
        current_revision: 1
      sources:
        - id: cs_89ot0sdW7BgAjzyFyy62BH
          claim_id: c_CruOTXwGSCRmT0sZDIct2R
          source_id: s_o2vJYX59VTtFhAS52QxvCq
          stance: supports
          locator: 萬曆二十年壬辰科進士歷履便覽:一卷，第三甲第六十名：子
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_o2vJYX59VTtFhAS52QxvCq
            source_type: api_record
            title: 中国历代人物传记资料库：王謠（CBDB 232703）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=232703&o=json
            external_identifier: CBDB:232703
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-09T00:03:17.706Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_L1Hr72ZKdktC6H481ZmUUG
        status: active
        display_name: 王謠
  ...
  ancestors:
    - claim:
        id: c_nQ6aYSPUihZnUZ8v2Mn3OD
        subject_person_id: p_98Jso86aF8E7RjpQfR3sns
        claim_kind: relationship
        ...
        current_revision: 1
      sources:
        - id: cs_IVxaJcxf2lLr8bHASF-h1z
          claim_id: c_nQ6aYSPUihZnUZ8v2Mn3OD
          source_id: s_k5QCD1BmfzeiTKCSwWBkUb
          stance: supports
          locator: 萬曆二十年壬辰科進士歷履便覽:一卷，第三甲第六十名：曾孫; 重孫
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_k5QCD1BmfzeiTKCSwWBkUb
            source_type: api_record
            title: 中国历代人物传记资料库：王翔（CBDB 232701）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=232701&o=json
            external_identifier: CBDB:232701
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-09T00:03:17.704Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_98Jso86aF8E7RjpQfR3sns
        status: active
        display_name: 王翔
        merged_into_person_id: null
    - claim:
...
| bio.summary | 王大合（生于1568年），明人物。入仕進士。（中国历代人物传记资料库 CBDB 207604） | accepted |
