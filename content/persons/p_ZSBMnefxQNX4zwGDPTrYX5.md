  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王方庆（？—702年），名綝，字方庆，以字行，是唐朝、武周官员，武则天年间拜相，封石泉县公，谥贞。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 3
      sources:
        - id: cs_dksLqg5b7EKyEosT5Xz2LY
          claim_id: c_o6V8PNTy5jToMfN3DPJZ7j
        ...
        - id: cs_a4QzHn2QnKBhH8TCGEqgJ5
          claim_id: c_o6V8PNTy5jToMfN3DPJZ7j
          source_id: s_D3xa3zoRJ2JKJ66y2m6CLt
          stance: supports
          locator: 导言
          quotation: 武则天年间为宰相
          interpretation_note: 据人物条目导言概括生卒、籍贯与身份。
          source:
            id: s_D3xa3zoRJ2JKJ66y2m6CLt
            source_type: website
            title: 中文维基百科：王方庆
            creator: 维基百科贡献者
            publisher: Wikimedia Foundation
            published_at_text: null
            canonical_url: https://zh.wikipedia.org/wiki/%E7%8E%8B%E6%96%B9%E5%BA%86
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_vb5Pi3PrHBfXeTS6pKk1H9
          claim_id: c_kwkR9CQWKaiWTniRHoeQWX
          source_id: s_CTC777F2HSKbjF4ZdjzJur
          stance: supports
          locator: null
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_AAxG35H8mJGg11mTR4p2EL
          claim_id: c_k2Z6boj365e5uqSZL4oVE2
          source_id: s_CTC777F2HSKbjF4ZdjzJur
          stance: supports
          locator: Q7478164
          quotation: null
...
relationships:
  parents:
    - claim:
        id: c_rZwa1oKpyv1AzeUDMw7RRs
        subject_person_id: p_ujGjqexGpFHSeeL644vaA9
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_ZSBMnefxQNX4zwGDPTrYX5
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 3
      sources:
        - id: cs_gZS5QHLiBbipaBfSGFJfuJ
          claim_id: c_rZwa1oKpyv1AzeUDMw7RRs
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王方庆（？—702年），名綝，字方庆，以字行，是唐朝、武周官员，武则天年间拜相，封石泉县公，谥贞。 | accepted |
| death.date | 702年 | accepted |
| name.primary | 王方庆 | accepted |
...
| children | p_LPg6udkMsMFQajuGotTCsg | 王晞 | accepted |
| children | p_f2E3depAV8At1mvv8ZEHkb | 王晦 | accepted |
| children | p_4HKPieD6fbNJ6PWBDrdsH7 | 王曒 | accepted |
| children | p_WdFmE9KEnRrkWkP6FtALJ2 | 王晊 | accepted |
| children | p_hKTs5TTRzKAYzyv3cFGKZB | 王晔 | accepted |
| children | p_zKiyG8Et428Qshx93cGmXx | 王暟 | accepted |
| children | p_f4HMpBBbSKyMnBCWcM6B3J | 王昕 | accepted |
| children | p_B9cesCgD7mqBrmZ8ukgb39 | 王𬀩 | accepted |
| children | p_YHE2NJ9LSwowSpyQD68iW1 | 王晖 | accepted |
...
- [中文维基百科：王方庆](https://zh.wikipedia.org/wiki/%E7%8E%8B%E6%96%B9%E5%BA%86)
