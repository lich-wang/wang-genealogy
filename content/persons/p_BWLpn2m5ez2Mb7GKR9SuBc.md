...
properties:
  - predicate: name.primary
    recommended:
      claim:
        id: c_pyCSV9itrm5qbi6XQeQask
        subject_person_id: p_BWLpn2m5ez2Mb7GKR9SuBc
        claim_kind: property
        predicate: name.primary
        ...
        current_revision: 1
      sources:
        - id: cs_kPM9ZjXm1BnB3Q3QwUzsMU
          claim_id: c_pyCSV9itrm5qbi6XQeQask
          source_id: s_1P2U5PSqQc9N72yEK55M1d
          stance: supports
          locator: CBDB:437574
          quotation: null
          interpretation_note: CBDB 明确记录的王姓历史人物（437574）
          source: &a1
  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王誾，元人物。籍贯金華，身份为工於文。（中国历代人物传记资料库 CBDB 437574）
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_ue3u-G_em3SIySvjD_3JL6
          claim_id: c_iobbiCUnNfcGqKh6iEZCVM
          source_id: s_1P2U5PSqQc9N72yEK55M1d
          stance: supports
          locator: CBDB:437574
          quotation: null
...
| bio.summary | 王誾，元人物。籍贯金華，身份为工於文。（中国历代人物传记资料库 CBDB 437574） | accepted |
