  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王晏（654年—709年），史料所见人物。本项目依据《中国历代人物传记资料库：王晏（CBDB 142376）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_OfPdavjmwJ52vsoglzWUsr
...
relationships:
  parents:
    - claim:
        id: c_mNjRmzVYMDv7kkdfbnAfzT
        subject_person_id: p_3cRnocF1N2MLZ4YJNCy4yo
        ...
        current_revision: 1
      sources:
        - id: cs_vT0y_o0zUNoyyJqkThVrHr
          claim_id: c_mNjRmzVYMDv7kkdfbnAfzT
          source_id: s_c7h8qAMPRgQnxpG8H7DUAv
          stance: supports
          locator: 唐代墓誌彙編續集，(XJ)Jinglong13：子
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_c7h8qAMPRgQnxpG8H7DUAv
            source_type: api_record
            title: 中国历代人物传记资料库：王某觀（CBDB 163585）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=163585&o=json
            external_identifier: CBDB:163585
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-06T01:16:54.741Z
            metadata_json:
              source_release: CBDB 2026-08-29
      object_person:
        id: p_3cRnocF1N2MLZ4YJNCy4yo
        status: active
        display_name: 王某觀
  ...
  children:
    - claim:
      ...
      object_person:
        ...
        merged_into_person_id: null
    - claim:
        id: c_s2hJOcgKRttC2zA2VfbXZZ
        subject_person_id: p_VNFXwWD4uW7ZZwVXfNErsr
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_ffz4n1JTDnYZFzgrFj3j92
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_NcojcqMHFzDk0k83_v-Ewj
          claim_id: c_s2hJOcgKRttC2zA2VfbXZZ
          source_id: s_TB4s8BMBUAgKJADR7UiFWD
          stance: supports
          locator: 唐代墓誌彙編續集，(XJ)Jinglong13：父
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_TB4s8BMBUAgKJADR7UiFWD
            source_type: api_record
            title: 中国历代人物传记资料库：王曜（CBDB 163589）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=163589&o=json
            external_identifier: CBDB:163589
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-09T00:03:15.960Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_ffz4n1JTDnYZFzgrFj3j92
        status: active
        display_name: 王曜
        merged_into_person_id: null
    - claim:
...
| bio.summary | 王晏（654年—709年），史料所见人物。本项目依据《中国历代人物传记资料库：王晏（CBDB 142376）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |

## 关联关系

| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| parents | p_3cRnocF1N2MLZ4YJNCy4yo | 王某觀 | accepted |
| children | p_4qEC6svJUXem3b3PUvCg4p | 王曉 | accepted |
| children | p_ffz4n1JTDnYZFzgrFj3j92 | 王曜 | accepted |
| children | p_mVkRpjNCSf52jmYn4ci7e2 | 王昕 | accepted |
| children | p_woqEE9m1vxbSja7pejiELv | 王晧 | accepted |
...
- [中国历代人物传记资料库：王某觀（CBDB 163585）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=163585&o=json)
...
- [中国历代人物传记资料库：王曜（CBDB 163589）](https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=163589&o=json)
