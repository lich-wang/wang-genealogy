  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王怡政（782年—854年），史料所见人物。本项目依据《中国历代人物传记资料库：王怡政（CBDB 146314）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_Wr1nuCC5GnKe6P124It_EQ
          claim_id: c_bFc67HT4BbUyFkQ1F4KgHK
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_77CRfU5YJ6tMSx4QLfK9R1
          claim_id: c_eUm6pDVLFqCD3pRz2YBJZ1
          source_id: s_jj9pH1K8E1rHVwKkhYMsU8
          stance: supports
          locator: CBDB:146314
          quotation: null
          interpretation_note: CBDB 2026-08-29 Luna 审核通过人物批量导入（401-500）｜历史性依据：CBDB 卒年 = 854
          source:
            id: s_jj9pH1K8E1rHVwKkhYMsU8
            source_type: api_record
            title: 中国历代人物传记资料库：王怡政（CBDB 146314）
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_9aDDeyL8qZuAHLNut2srz9
          claim_id: c_WEK51Nj1JDCmg4ym7riCHH
          source_id: s_jj9pH1K8E1rHVwKkhYMsU8
          stance: supports
          locator: CBDB:146314
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_wUoa9c2xyW29kmiuF7GpNk
          claim_id: c_z5tWKqzk9TSHYvFFZVYAoL
          source_id: s_jj9pH1K8E1rHVwKkhYMsU8
          stance: supports
          locator: CBDB:146314
          quotation: null
...
relationships:
  ...
  children:
    - claim:
        id: c_Xn_m_8Y8EyK4TIHPhpBhzo
        subject_person_id: p_A14LP6YVSXyCHjhPT46BAe
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_u9yz959yzCmGhwzLGhKpCF
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_d21d5ZoxCsk_GW7PtYK2zS
          claim_id: c_Xn_m_8Y8EyK4TIHPhpBhzo
          source_id: s_iS7Mob172GsH43uZj7PVFs
          stance: supports
          locator: 唐五代人物傳記與社會網絡資料庫(1.0版)：父
          quotation: null
          interpretation_note: Luna 在线复核 CBDB 实时 API 后补全；关系端点按 CBDB ID 唯一映射。
          source:
            id: s_iS7Mob172GsH43uZj7PVFs
            source_type: api_record
            title: 中国历代人物传记资料库：王景宣（CBDB 186489）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=186489&o=json
            external_identifier: CBDB:186489
            license_code: CC-BY-NC-SA-4.0
            accessed_at: 2026-09-09T00:03:16.273Z
            metadata_json:
              source_release: CBDB 2026-09-05
      object_person:
        id: p_u9yz959yzCmGhwzLGhKpCF
        status: active
        display_name: 王景宣
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王怡政（782年—854年），史料所见人物。本项目依据《中国历代人物传记资料库：王怡政（CBDB 146314）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| birth.date | 782年 | accepted |
| death.date | 854年 | accepted |
| name.primary | 王怡政 | accepted |
