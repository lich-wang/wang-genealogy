...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_yV4JJeuWsCHzzggEAGS8d2
        subject_person_id: p_YTphbxsFBQ8wzvqK1botSe
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王菼，史料所见人物。本项目依据《中国历代人物传记资料库：王菼（CBDB 526817）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_B50hhXD-cb7HuZG2n7DcqS
          claim_id: c_yV4JJeuWsCHzzggEAGS8d2
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_hUpWLQeRM9ViCE1qyrvyg8
          claim_id: c_LrCLPQMmZ7afCWFSDCMYBp
          source_id: s_8GnBPMqBtVJkRTiEawCW7M
          stance: supports
          locator: CBDB:526817
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王菼，史料所见人物。本项目依据《中国历代人物传记资料库：王菼（CBDB 526817）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王菼 | accepted |
