  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王鬷（978年—1041年），史料所见人物。本项目依据《中国历代人物传记资料库：王鬷（CBDB 1903）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_qDCzuVhAOBWzMg52easFrS
          claim_id: c_THw9tVKsQoSuhCsi7D9dx9
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_7ESDEzdBX75Sxrgwuwdt9J
          claim_id: c_jSY318wdv31gD3LD84egTs
          source_id: s_MRaTnYLLP1EZjec7BF8yEM
          stance: supports
          locator: CBDB:1903
          quotation: null
          interpretation_note: CBDB 2026-08-29 Luna 审核通过人物批量导入（1-100）｜历史性依据：CBDB 卒年 = 1041
          source:
            id: s_MRaTnYLLP1EZjec7BF8yEM
            source_type: api_record
            title: 中国历代人物传记资料库：王鬷（CBDB 1903）
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_N2WRpSTjMgrv7QcWzn4nJk
          claim_id: c_mQn3kvPAtHzf893YENrfr3
          source_id: s_MRaTnYLLP1EZjec7BF8yEM
          stance: supports
          locator: CBDB:1903
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_vgnWNHbABQnAAm55jJfT6a
          claim_id: c_GHfDe6cFfApDPJoewwWg6o
          source_id: s_MRaTnYLLP1EZjec7BF8yEM
          stance: supports
          locator: CBDB:1903
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王鬷（978年—1041年），史料所见人物。本项目依据《中国历代人物传记资料库：王鬷（CBDB 1903）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| birth.date | 978年 | accepted |
| death.date | 1041年 | accepted |
| name.primary | 王鬷 | accepted |
