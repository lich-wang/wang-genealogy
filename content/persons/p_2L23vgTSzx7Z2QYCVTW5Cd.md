...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_t41kzdy2v4ZaC1t85toc3H
        subject_person_id: p_2L23vgTSzx7Z2QYCVTW5Cd
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王仁福（1819年—1867年），史料所见人物。本项目依据《中国历代人物传记资料库：王仁福（CBDB 69082）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 6
      sources:
        - id: cs_D2YZ_CdI9k7zpQYSLGN2p8
          claim_id: c_t41kzdy2v4ZaC1t85toc3H
          source_id: s_r9vxfzjNd9TiQdLNfGhx9e
          stance: supports
          locator: CBDB:69082
          quotation: null
          interpretation_note: 自动补全人物基本介绍；身份由稳定外部标识锁定，信息来源层级为 source。
          source: &a1
            id: s_r9vxfzjNd9TiQdLNfGhx9e
            source_type: api_record
            title: 中国历代人物传记资料库：王仁福（CBDB 69082）
            creator: China Biographical Database (CBDB)
            publisher: Harvard University / Academia Sinica / Peking University
            published_at_text: null
            canonical_url: https://cbdb.fas.harvard.edu/cbdbapi/person.php?id=69082&o=json
            external_identifier: CBDB:69082
  ...
  - predicate: birth.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_EdvuZ1e3HbFmWuDWc4R8dX
          claim_id: c_G8ARK8iYSW9CwP1JH1Sf6u
          source_id: s_r9vxfzjNd9TiQdLNfGhx9e
          stance: supports
          locator: CBDB:69082
          quotation: null
  ...
  - predicate: death.date
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_gmcnmK4F5hBvFPKbow16yA
          claim_id: c_ARNZrMUNvQqUgVFx4ZWPPM
          source_id: s_r9vxfzjNd9TiQdLNfGhx9e
          stance: supports
          locator: CBDB:69082
          quotation: null
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_tr3XxmWGjtPA8LTvaPr1ov
          claim_id: c_LUJWH4CFmkLK36qR95m2mS
          source_id: s_r9vxfzjNd9TiQdLNfGhx9e
          stance: supports
          locator: CBDB:69082
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王仁福（1819年—1867年），史料所见人物。本项目依据《中国历代人物传记资料库：王仁福（CBDB 69082）》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| birth.date | 1819年 | accepted |
| death.date | 1867年 | accepted |
| name.primary | 王仁福 | accepted |
