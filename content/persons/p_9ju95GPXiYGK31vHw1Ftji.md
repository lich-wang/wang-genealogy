...
properties:
  - predicate: bio.summary
    recommended:
      claim:
        id: c_QXptAyffSQyhvQ_JAid2cc
        subject_person_id: p_9ju95GPXiYGK31vHw1Ftji
        claim_kind: property
        predicate: bio.summary
        ...
        parent_role: null
        value_json:
          text: 王婼，史料所见人物。本项目依据《王绚 (南朝)》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。
          language: zh-Hans
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_GQf7BOXqxnnWZAy9lVL53M
          claim_id: c_QXptAyffSQyhvQ_JAid2cc
  ...
  - predicate: name.primary
    recommended:
      claim:
        ...
        current_revision: 2
      sources:
        - id: cs_gkdwhJiawKbhG2PRVDfWDf
          claim_id: c_FbBph6wBE5435zzo99xCQP
          source_id: s_7rmBMuj1fnoHM2Bv8pmLiR
          stance: supports
          locator: CBDB:null
          quotation: null
...
| 字段 | 内容 | 状态 |
| --- | --- | --- |
| bio.summary | 王婼，史料所见人物。本项目依据《王绚 (南朝)》所载的独立记录收录其姓名；目前可核实的信息仍较有限，生卒年代、籍贯与具体经历有待更多可靠来源补充。 | accepted |
| name.primary | 王婼 | accepted |

## 关联关系

| 关系 | 人物 ID | 姓名 | 状态 |
| --- | --- | --- | --- |
| parents | p_2gQFBWYT57n4iwLPS872kN | 王绚 | accepted |
