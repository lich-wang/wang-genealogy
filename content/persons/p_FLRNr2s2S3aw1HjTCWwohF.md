  ...
  - predicate: bio.summary
    recommended:
      claim:
        ...
        parent_role: null
        value_json:
          text: 王回（1121年—1192年），宋人物。籍贯瑞安，入仕進士，曾任朝請大夫、路提點刑獄公事、檢正中書五房公事。（中国历代人物传记资料库 CBDB 22031）
          language: zh-Hant
        status: accepted
        confidence: medium
        current_revision: 2
      sources:
        - id: cs_DY1mERDMl2XRgnLQFQo2rs
...
relationships:
  ...
  children:
    - claim:
        id: c_Y5r2z_Fb_jA8ORPjkacUU7
        subject_person_id: p_FLRNr2s2S3aw1HjTCWwohF
        claim_kind: relationship
        predicate: kinship.father_of
        object_person_id: p_CcSeYesqggrZm5aEhuP8DZ
        generation_count: null
        parent_role: father
        value_json: null
        status: accepted
        ...
        current_revision: 1
      sources:
        - id: cs_LvPPhJD9O5rtmnFm9nkURL
          claim_id: c_Y5r2z_Fb_jA8ORPjkacUU7
          source_id: s_0QRfGzeI0_8CkBmQaNViSl
          stance: supports
          locator: CBDB 亲属：父（KinPerson 22031）
          quotation: null
          interpretation_note: CBDB 直接记录的父／母关系。
          source:
            id: s_0QRfGzeI0_8CkBmQaNViSl
            source_type: api_record
...
| bio.summary | 王回（1121年—1192年），宋人物。籍贯瑞安，入仕進士，曾任朝請大夫、路提點刑獄公事、檢正中書五房公事。（中国历代人物传记资料库 CBDB 22031） | accepted |
...
| children | p_CcSeYesqggrZm5aEhuP8DZ | 王自適 | accepted |
